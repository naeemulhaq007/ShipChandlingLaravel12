...
(function ($) {
    ...
    $.fn.ajaxlivesearch = function (options) {
        ...
        $.fn.ajaxlivesearch.ls = ls; // expose it by mai
        console.log(ls);
        console.log($.fn.ajaxlivesearch);
        /**
        ...
        this.each(function () {
            ...
            //result.css({ left: query.position().left + 1, width: query.outerWidth() - 2 }); mai
            result.css({ left: query.position().left + 1 });  //mai
