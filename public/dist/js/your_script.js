let slide_data = [
    {
      'src':'/dist/images/banner12.jpg',
      'title':'Provision',
      'copy':'Thanks For Your Order In Provision.'
    },
    {
      'src':'/dist/images/ban5.jpeg',
      'title':'Provision',
      'copy':'Thanks For Your Order In Provision.'
    },
    {
      'src':'/dist/images/ban3.jpg',
      'title':'Bonded',
      'copy':'Thanks For Your Order In Bonded.'
    },
    {
      'src':'/dist/images/ban2.jpg',
      'title':'Provision',
      'copy':'Thanks For Your Order In Provision.'
    },
  ...
  for (let i = 0; i< slide_data.length; i++){
    ...
    caption.insertAdjacentHTML('beforeend','<div class="caption-subhead"><span>Thanks For Choosing US. </span></div>');
    slides.push(slide);
