        ...
        <div class="col-lg-12 pt-3">
            ...
            <div class="card ">
                <div class="card-header ">
                    ...
                    <b>
                        <h4 class="text-black">Income Statement Report</h4>
                    </b>
                        ...
                        <div class="col-lg-6">
                                ...
                                <div class="input-group col-sm-12 ">
                                    ...
                                    <div class="inputbox col-sm-9">
                                        <select name="CmbGodownName" id="CmbGodownName" disabled>
                                            @foreach ($GodownSetup as $GodownSetupitem)
                                                <option value="{{ $GodownSetupitem->GodownCode }}">{{ $GodownSetupitem->GodownName }}
                                                </option>
                                            @endforeach
                                        </select>
                                        <span class="Txtspan">
                                    ...
                                    <div class="CheckBox1">
                                        <label class="input-group text-info ml-2">
                                            <input class="" type="checkbox" name="ChkGodownAll"
                            ...
                            <div class="row py-2">
                                <div class="input-group col-sm-12 ">
                                    ...
                                    <div hidden class="inputbox col-sm-2 ">
                                        <input type="hidden" class=" " value="" id="TxtBranchCode" required="required">
                                        <span class="ml-2">
                                            B.Code
                                        </span>
                                    </div>
                                    <div class="inputbox col-sm-9">
                                        <select name="TxtBranchName" id="TxtBranchName" disabled>
                                            @foreach ($branchlist as $branchlistitem)
                                                <option value="{{ $branchlistitem->BranchCode }}">{{ $branchlistitem->BranchName }}</option>
                                            @endforeach
                                        </select>
                                        <span class="Txtspan">
                                            Branch Name
                                    ...
                                    <div class="CheckBox1">
                                        <label class="input-group text-info ml-2">
                                            <input class="" type="checkbox" name="ChkBranchALL"
                            ...
                            <div class="row py-2">
                                <div class="input-group col-sm-12 ">
                                    ...
                                    <div class="inputbox col-sm-9">
                                        <input type="text" class=""id="TxtSearchAc" readonly disabled required="required">
                                        <span class="Txtspan">
                                            Search A/C
                                        </span>
                                    </div>
                                    ...
                                    <div class="CheckBox1">
                                        <label class="input-group text-info ml-2">
                                            <input class="" type="checkbox" name="ChkSearchAcAll"
                                                id="ChkSearchAcAll" checked value=""> All
                                        </label>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row py-2">
                                <div class="input-group col-sm-12 ">
                                    ...
                                    <div class="inputbox col-sm-9">
                                        <input type="text" class="" id="TxtNetIncome"
                                            required="required">
                                        <span class="Txtspan">
                                            Net Income
                                        </span>
                            ...
                            <div class="row ml-1 py-2">
                                <button class="btn btn-info col-sm-2" id="CmdGenerateNew" role="button">
                                    <i class=" fa  fa-file-alt mr-1"></i>

                                    Consolidated</button>
                                <button class="btn btn-info col-sm-4 ml-3" id="CmdGenerateNew1" role="button">
                                    <i class="fa fa-copy mr-1   "></i>
                                    Consolidated With PO Not Delivered</button>
                                <button class="btn btn-info col-sm-2 ml-3" id="CmdGenerate" role="button"><i class="fa fa-location-dot mr-1"></i>
                                   LocationWise </button>
                                <button class="btn btn-info col-sm-2 ml-3" id="CmdBalanceSheet" role="button">
