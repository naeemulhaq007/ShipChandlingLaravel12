        ...
        <div class="col-lg-12 pt-3">
            ...
            <div class="card ">
                <div class="card-header ">
                    ...
                    <b>
                        <h4 class="text-black">Card Setup</h4>
                    </b>
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <div class="row py-2 ">
                                <div class="inputbox col-sm-5 ml-2">
                                    <input type="text" class="" hidden required="required">
                                    <span class="Txtspan">
                                        Company Code
                                    </span>
                                </div>
                            ...
                            <div class="row py-2 ">
                                <div class="inputbox col-sm-8 ml-2">
                                    <input type="date" class="" id="reg" required="required">
                                    <span class="Txtspan">
                                        Registration Date
                                    </span>
                                </div>
                            ...
                            <div class="row ml-1 py-2">
                                <button class="btn btn-primary  mx-2" id="CmdGenerateNew" role="button"> <i
                                        class="fa fa-plus mr-1" aria-hidden="true"></i>New</button>

                                <button class="btn btn-success mx-2" id="Button9" role="button"> <i
                                        class="fa fa-save mr-1" aria-hidden="true"></i>Save</button>
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="row ml-1 py-2">
                                <button class="btn btn-info  mx-2" id="CmdGenerateNew" role="button"> <i
                                        class="fa fa-photo mr-1" aria-hidden="true"></i>Get Picture</button>

                                <button class="btn btn-dark mx-2" id="Button9" role="button"> <i
                                        class="fa fa-remove mr-1" aria-hidden="true"></i>Clear</button>
