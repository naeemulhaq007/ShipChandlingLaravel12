        ...
        <div style="background-color:#EEE" class="card-header">
            ...
            <div class="row">
                ...
                <div class="col-form-label row ml-2 ">
                    <strong>OrderNo # :&nbsp;</strong> <label class="Order_no text-blue" for="Order_no"><input
                    ...
                    <div class="row py-2">
                        ...
                        <div class="CheckBox1 ml-2">
                            ...
                            <label class="input-group text-info">
                                <input type="checkbox" name="checkboxes1" id="checkboxes-0" value="1">
                                Quote Entry
                            </label>
                        ...
                        <div class="CheckBox1 ml-4">
                            ...
                            <label class="input-group text-info">
                                <input type="checkbox" name="checkboxes3" id="checkboxes-2" value="3">
                                Costed
                            </label>
                        ...
                        <div class="CheckBox1 ml-4">
                            ...
                            <label class="input-group text-info">
                                <input type="checkbox" name="checkboxes4" id="checkboxes-3" value="4">
                                Cell Priced
                            </label>
                        ...
                        <div class="CheckBox1 ml-4">
                            ...
                            <label class="input-group text-info">
                                <input type="checkbox" name="checkboxes5" id="checkboxes-4" value="5">
                                Re-Key
                            </label>
                        ...
                        <div class="CheckBox1 ml-4">
                            ...
                            <label class="input-group text-info">
                                <input type="checkbox" name="checkboxes6" id="checkboxes-5" value="6">
                                Sent To Cust
                            </label>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="row">
                        ...
                        <div class="inputbox col-sm-1">
                            <input type="number" value='' id="vendor_price" required>
                            <span>Vendor Price</span>
                        </div>

                        <div class="inputbox col-sm-1">
                            <input type="number" value='' required tabindex="18" onkeyup="reSum();"
                                onblur="reSum();" id="sell_price">
                        ...
                        <div class="inputbox col-sm-1">
                            ...
                            <button class="btn btn-success col-sm-1" id="saveitem" type="button">Add</button>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="row py-2">
                        ...
                        <button class="btn btn-primary col-sm-1" id="clearform" type="button">Clear</button>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="row py-1">
                        ...
                        <button id="btnExport" class="btn btn-primary col-sm-2 mx-1">Export</button>
                    ...
                    <div class="row py-1">
                        ...
                        <div class="form-check form-check-inline col-sm-2">
                            <label class="form-check-label ">
                                <input class="form-check-input " type="checkbox" name="ShowinKG" id="ShowinKG"
                                    value=""> Show in KG
                            </label>
                        </div>
                ...
                <form id="importForm" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group mx-1">
                                <label for="start_column">Impa Column</label>
                                <input type="text" name="Impacolumn" id="Impacolumn" class="form-control" required>
                            </div>
                        ...
                        <div class="row">
                            <div class="input-group col-sm-3 py-1">
                                ...
                                <input class="form-control" type="text" name="itemCodeColumn" id="itemCodeColumn">
                            </div>
                            <div class="input-group col-sm-3 py-1">
                                <div class="input-group-prepend">
                                    <span class="input-group-text" id="">Item Name</span>
                                </div>
                                <input class="form-control" type="text" name="itemNameColumn" id="itemNameColumn">
                            </div>
                            <div class="input-group col-sm-3 py-1">
                                <div class="input-group-prepend">
                                    <span class="input-group-text" id="">UOM </span>
                                </div>
                                <input class="form-control" type="text" name="uomColumn" id="uomColumn">
                            </div>
                            <div class="input-group col-sm-3 py-1">
                                <div class="input-group-prepend">
                                    <span class="input-group-text" id="">Vendor Price </span>
                                </div>
                                <input class="form-control" type="text" name="vendorPriceColumn"
                                    id="vendorPriceColumn">
                            </div>
                            <div class="input-group col-sm-3 py-1">
                                <div class="input-group-prepend">
                            ...
                            <div class="input-group col-sm-3 py-1">
                                <div class="input-group-prepend">
                                    <span class="input-group-text" id="">Vendor Name </span>
                                </div>
                                <input class="form-control" type="text" name="VendorNameColumn"
                                    id="VendorNameColumn">
                            </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#btnrfq').click(function(e) {
                e.preventDefault();
                var quotno = $('#Order_no').val();
                window.open('/quotation/rfq/' + quotno, 'RFQ', 'height=800,width=1200,top=200,left=200');
                return false;
            });
            ...
            $('#btnpricing').click(function(e) {
                e.preventDefault();
                var quotno = $('#Order_no').val();
                window.location.href = '/quotation/pricing/' + quotno;
            });
