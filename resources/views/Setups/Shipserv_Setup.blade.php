        ...
        <div class="col-lg-12 pt-3">
            ...
            <div class="card ">
                <div class="card-header ">
                    ...
                    <b>
                        <h2 class="text-center">Shipserv Status</h2>
                    </b>
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="row">
                                <div class="inputbox col-sm-8 py-2">
                                    <input type="text" class="" id="TxtShipServCode" name="TxtShipServCode" required="required">
                                    <span class="Txtspan">
                                        Code </span>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="inputbox col-sm-8 py-2">
                                    <input type="text" class="" id="TxtTradeID" name="TxtTradeID" required="required">
                                    <span class="Txtspan">
                                        Trade Id </span>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="inputbox col-sm-8 py-2">
                                    <input type="text" class="" id="TxtTradeDesc" name="TxtTradeDesc" required="required">
                                    <span class="Txtspan">
                                        Trade Desc. </span>
                                    </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="inputbox col-sm-8 py-2">
                                    <input type="text" class="" id="TxtGrantType" name="TxtGrantType" required="required">
                                    <span class="Txtspan">
                                        Grant Type </span>
                                    </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="inputbox col-sm-8 py-2">
                                    <input type="text" class="" id="TxtPassword" name="TxtPassword" required="required">
                                    <span class="Txtspan">
                                        Password</span>
                                    </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="inputbox col-sm-8 py-2">
                                    <input type="text" class="" id="TxtClientID" name="TxtClientID"
                                        required="required">
                                    <span class="Txtspan">
                                        Client ID</span>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="inputbox col-sm-8 py-2">
                                    <input type="text" class="" id="TxtClientSecret" name="TxtClientSecret"
                                        required="required">
                                    <span class="Txtspan">
                                        Client Secret</span>
                                </div>
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="rounded shadow">
                                        <table class="table small" id="Gd1">
                                            ...
                                            <tbody id="Gd1body">
                                                @foreach ($Shiptable as $Shiptableitem)
                                                    <tr>
                                                        <td>{{ $Shiptableitem->ShipServCode }}</td>

                                                        <td>{{ $Shiptableitem->TradeID }}</td>

                                                        <td>{{ $Shiptableitem->TradeName }}</td>

                                                        <td>{{ $Shiptableitem->GrantType }}</td>

                                                        <td>{{ $Shiptableitem->username }}</td>

                                                        <td>{{ $Shiptableitem->Password }}</td>

                                                        <td>{{ $Shiptableitem->ClientId }}</td>

                                                        <td>{{ $Shiptableitem->ClientSecret }}</td>
