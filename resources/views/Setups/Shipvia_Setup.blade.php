        ...
        <div class="col-lg-12 pt-3">
            ...
            <div class="card ">
                <div class="card-header ">
                    ...
                    <b>
                        <h2 class="text-center">Ship Via</h2>
                    </b>
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <div class="row">
                                <div class="inputbox col-sm-8 py-2">
                                    <input type="text" class="" id="TxtShipVIAName" name="TxtShipVIAName" required="required">
                                    <span class="Txtspan">
                                        Ship VIA </span>
                                </div>
                            ...
                            <div class="row">
                                <div class="inputbox col-sm-8 py-2">
                                    <input type="text" class="" id="TxtShipTo" name="TxtShipTo" required="required">
                                    <span class="Txtspan">
                                        Ship To </span>
                                </div>
                            ...
                            <div class="row">
                                <div class="inputbox col-sm-8 py-2">
                                    <input type="textarea" class="" id="TxtShipDetail" name="TxtShipDetail" required="required">
                                    <span class="Txtspan">
                                        Ship Detail </span>
                                </div>
                            ...
                            <div class="row py-2">
                                ...
                                <button class="btn btn-success mx-2" id="Button2" role="button"> <i
                                        class="fa fa-cloud mr-1" aria-hidden="true"></i>Save</button>

                                <button class="btn btn-warning mx-2" id="Button3" role="button"> <i
                                        class="fa fa-multiply mr-1" aria-hidden="true"></i>Delete</button>

                                <button class="btn btn-danger mx-2" id="Button4" role="button"> <i
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="rounded shadow">
                                        <table class="table small" id="Gd1">
                                            ...
                                            <tbody id="Gd1body">
                                                @foreach ($shipvia as $shipviaitem)
                                                    <tr>
                                                        <td>{{ $shipviaitem->ShipVIACode }}</td>
                                                        <td>{{ $shipviaitem->ShipVIAName }}</td>
                                                    </tr>
                                                @endforeach
                                            </tbody>
                                        </table>
