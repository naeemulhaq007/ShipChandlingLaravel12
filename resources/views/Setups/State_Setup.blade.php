        ...
        <div class="col-lg-12 pt-3">
            ...
            <div class="card ">
                <div class="card-header ">
                    ...
                    <b>
                        <h2 class="text-center">State Setup</h2>
                    </b>
                            ...
                            <div class="row">
                                ...
                                <div class="inputbox col-sm-8 py-2">
                                    ...
                                    <div class="row py-2">
                                        ...
                                        <button class="btn btn-warning mx-2" id="CmdPrint" role="button"> <i class="fa fa-multiply mr-1"
                                                aria-hidden="true"></i>Delete</button>
                                        <button class="btn btn-danger mx-2" id="CmdExit" role="button"> <i class="fa fa-door-open mr-1"
                                        ...
                                        <table class="table small" id="Gd1">
                                            ...
                                            <tbody id="Gd1body">
                                                @foreach ($state as $stateitem)
                                                    <tr>
                                                        <td>{{ $stateitem->StateCode }}</td>

                                                        <td>{{ $stateitem->StateName }}</td>

                                                        <td>{{ $stateitem->ChkInactive }}</td>
                                                    </tr>
                                                @endforeach
                                            </tbody>
                                        </table>
