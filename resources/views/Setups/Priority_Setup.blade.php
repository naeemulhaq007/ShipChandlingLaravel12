        ...
        <div class="col-lg-12 pt-3">
            ...
            <div class="card ">
                <div class="card-header ">
                    ...
                    <b>
                        <h2 class="text-center">Priority Setup</h2>
                    </b>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <div class="row">
                                ...
                                <div class="inputbox col-sm-8 py-2">
                                    <input type="text" class="" id="TxtStatusName" name="TxtStatusName"
                                        required="required">
                                        <span class="Txtspan">
                                           Priority</span>
                                        </div>
                                    ...
                                    <div class="row py-2">
                                        <button class="btn btn-primary  mx-2" id="Button1" role="button"> <i class="fa fa-plus mr-1"
                                                aria-hidden="true"></i>Add</button>

                                        <button class="btn btn-success mx-2" id="Button2" role="button"> <i class="fa fa-cloud mr-1"
                                        ...
                                        <table class="table small" id="Gd1">
                                            ...
                                            <tbody id="Gd1body">
                                                @foreach ($priority as $priorityitem)
                                                    <tr>
                                                        <td>{{ $priorityitem->PriorityCode }}</td>

                                                        <td>{{ $priorityitem->PriorityName }}</td>
                                                    </tr>
                                                @endforeach
                                            </tbody>
                                        </table>
