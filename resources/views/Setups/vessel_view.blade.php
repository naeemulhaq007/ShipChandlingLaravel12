            ...
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="card-tools ml-auto">
                            <div class="row">
                                <a name="impcuslist" id="impcuslist" class="btn btn-default text-success  ml-auto"
                                    role="button">IMPORT List</a>
                ...
                <div class="card-body">
                    ...
                    <div class="row py-1">
                        ...
                        <input type="hidden" class="" value="{{ $code ? $code : '' }}" name="companycode"
                            id="companycode">

                        <div class="inputbox py-2 col-sm-5">
                            <input type="text" class="" id="discompanyname" value="{{ $name ? $name : '' }}"
                                readonly name="discompanyname" data-toggle="modal" data-target="#searchrmod"
                                required="required">
                    ...
                    <div class="row">
                        ...
                        <div class="inputbox col-sm-5 py-2">
                            <input type="text" class="" id="vesselname"
                                onblur="this.value = this.value.toUpperCase()" name="VesselName" required="required">
                            <span class="Txtspan">
                                Vessel Name
                            </span>
                        </div>
                    ...
                    <div class="row ">
                        <div class="inputbox col-sm-5 PY-2">
                            <input type="text" class="" id="vesseltype"
                                onblur="this.value = this.value.toUpperCase()" name="VesselType" list="type" required>
                            <datalist id="type">
                                <option value="Marine">
                                <option value="Tag">
                                <option value="Bulk">
                    ...
                    <div class="row py-2">
                        ...
                        <a name="" id="" class="btn btn-primary col-4 my-2 col-sm-1 mx-2"
                            onclick="location.reload();" role="button"><i class="fa fa-plus mr-1"
                                aria-hidden="true"></i>
                            New</a>
                        <button type="submit" class="btn col-sm-1 col-4 my-2 mx-2 btn-success "><i class="fa fa-cloud mr-1"
                                aria-hidden="true"></i> Save</button>
                        <a name="" id="DeleteBtn" class="btn col-sm-1 col-4 my-2 btn-warning mx-2" role="button"><i
                                class="fas fa-trash mr-1"></i> Delete</a>
                        <a name="" id="" href="/" class="btn col-sm-1 col-4 my-2 mx-2 btn-danger"
