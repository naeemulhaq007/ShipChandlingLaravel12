...
<div style="clear: both">
        ...
        <div class="row">
            ...
            <div class="col-sm-5">
        <input style="margin-bottom: 2%" type="text" value="{{$data->CustomerName}}" required name="CustomerName" class="form-control"  id="agentname"  placeholder="Empty">
            </div>
        </div>
        ...
        <div class="row" style="margin-bottom: 1%">
            ...
            <div class="col-sm-3">
        <input type="text" required name="agentcode" value="{{$data->CustomerCode}}" class="form-control"  id="CustomerCode"  placeholder="Empty">
            </div>
            <div style="text-align: right" class="col-sm-2">
                <label for="exchangeRate">Exchange Rate : </label>
                </div>
            <div class="col-sm-3">
        <input type="text" required name="exchangerate" class="form-control"  id="exchangeRate"  placeholder="Empty">
            </div>
        </div>
        <hr>
        ...
        <div class="row" style="margin-bottom: 1%">
            ...
            <div class="col-sm-3">
        <input type="text" required name="FaxNo" value="{{$data->FaxNo}}" class="form-control"  id="fax"  placeholder="Empty">
            </div>
        ...
        <div class="row" style="margin-bottom: 1%">
            ...
            <div class="col-sm-3">
        <input type="text" required name="WebAddress" class="form-control" value="{{$data->WebAddress}}" id="web"  placeholder="Empty">
            </div>
            ...
            <div style="text-align: right" class="col-sm-2">
                ...
                <div class="col-sm-3">
            <input type="text" required name="Country" class="form-control" value="{{$data->Country}}" id="country"  placeholder="Empty">
                </div>
        </div>
        <div class="row" style="margin-bottom: 1%">
            <div style="text-align: right" class="col-sm-2">
            ...
            <div class="col-sm-3">
        <input type="text" required name="City" class="form-control" value="{{$data->City}}"  id="city"  placeholder="Empty">
            </div>
            ...
            <div style="text-align: right" class="col-sm-2">
                ...
                <div class="col-sm-3">
            <input type="text" required name="State" class="form-control" value="{{$data->State}}"  id="state"  placeholder="Empty">
                </div>
        </div>
        <div class="row" style="margin-bottom: 1%">
            <div style="text-align: right" class="col-sm-2">
            ...
            <div class="col-sm-3">
        <input type="text" required name="Zip" class="form-control" value="{{$data->Zip}}" id="zip"  placeholder="Empty">
            </div>
        </div>
        ...
        <div class="row" style="margin-bottom: 1%">
            ...
            <div class="col-sm-5">
        <input type="text" required name="BillingAddress" class="form-control" value="{{$data->BillingAddress}}"  id="billingaddress"  placeholder="Empty">
            </div>
        </div>
        <div class="row" style="margin-bottom: 1%">
            <div style="text-align: right" class="col-sm-2">
        ...
        <div class="row" style="margin-bottom: 1%">
            ...
            <div class="col-sm-3">
        <input type="text" required name="BFaxNo" class="form-control" value="{{$data->BFaxNo}}"  id="bilingfax"  placeholder="Empty">
            </div>
        ...
        <div class="row" style="margin-bottom: 1%">
            ...
            <div class="col-sm-3">
        <input type="text" required name="BWeb" class="form-control" value="{{$data->BWeb}}" id="bilingweb"  placeholder="Empty">
            </div>
            ...
            <div style="text-align: right" class="col-sm-2">
                ...
                <div class="col-sm-3">
            <input type="text" required  name="Status" class="form-control" value="{{$data->Status}}"  id="bilingstatus"  placeholder="Empty">
                </div>
        </div>
        <div class="row" style="margin-bottom: 1%">
            <div style="text-align: right" class="col-sm-2">
            ...
            <div class="col-sm-3">
        <input type="text" required  name="CreditLimit" class="form-control"  value="{{$data->CreditLimit}}" id="creaditlimit"  placeholder="Empty">
            </div>
            ...
            <div style="text-align: right" class="col-sm-2">
                ...
                <div class="col-sm-3">
            <input type="text" required  name="Terms" class="form-control"  value="{{$data->Terms}}" id="terms"  placeholder="Empty">
                </div>
        </div>
        <div class="row" style="margin-bottom: 1%">
            <div style="text-align: right" class="col-sm-2">
