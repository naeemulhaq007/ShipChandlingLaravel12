...
@section('title', 'Sale-Return-Stock')
            ...
            <div class="card mt-3">
                ...
                <div class="card-body">
                    <div class="row py-2">
                        ...
                        <button name="" id="" class="btn btn-info mx-1 ml-3" role="button"><i
                    ...
                    <div class="row py-2">
                        <div class="inputbox col-sm-5">
                            <span class="Txtspan " id="">Cusotmer</span>
                        ...
                        <button name="" id="" class="btn btn-info mx-1" role="button"><i
                                class="fas fa-barcode    "></i> Print BarCode</button>
                    ...
                    <div class="row py-2 align-items-center">
                        ...
                        <div class="inputbox col-sm-1">
                            <span class="Txtspan" id=""> Stock Qty</span>
                ...
                <div class="card-body">
                    <div class="row py-1">
                        ...
                        <div class="CheckBox1">
                            ...
                            <label class="input-group mx-1 text-info">
