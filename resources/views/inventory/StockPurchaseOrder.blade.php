        ...
        <div class="col-lg-12">
            ...
            <div class="card mt-3">
                <div style="background-color:#EEE; " class="card-header">
                    ...
                    <div class="row">
                        <h5 class="">Create Stock Purchase Order</h5>
                        <a name="firstvoucher" data-voucherno="{{ $firstVoucherNo }}" id="firstvoucher"
                            class="btn btn-secondary mx-1 ml-auto" role="button"><i class="fa fa-arrow-left"
                ...
                <div class="card-body">
                    <div class="row py-2">
                        ...
                        <div class="inputbox col-sm-2">
                            ...
                            <select id="TxtTerms" name="TxtTerms">
                        ...
                        <button name="" id="" class="btn btn-success" role="button"><i
                                class="fab fa-plus text-white"></i> Stock</button>
                    ...
                    <div class="row py-2">
                        ...
                        <button role="button" data-toggle="modal" data-target="#chartofaccount" class="btn btn-info col-sm-1" id=""><i
                            class="fas fa-search    "></i></button>
                        <div class="inputbox col-sm-1">
                            <input readonly class="ml-1" type="text" id="TxtActCode" name="TxtActCode">
                        </div>

                            <div class="CheckBox1">
                                <label class="input-group text-info ml-2 mt-2">
                                    <input  type="checkbox" name="ChkNoCost" id="ChkNoCost" checked
                                        value=""> No Cost
                                </label>
                            </div>
                            {{-- <label class=" text-danger mx-1">
                                <input class=" " type="checkbox" onclick="" name="ChkNoCost" id="ChkNoCost"
                                    value=""> NO COST
                            </label> --}}
                    ...
                    <div class="row py-2">
                        ...
                        <button role="button" class="btn btn-info col-sm-1" id=""><i class="fas fa-search    "></i></button>
                        <div class="inputbox col-sm-1">

                        <input readonly class="ml-1" type="text" id="TxtGodownCode" name="TxtGodownCode">
                        </div>
                ...
                <select  class="custom-select" id="CmbGodownName" name="CmbGodownName">
                    ...
                    <option value="5">NEW YORK</option>
                        ...
                        <div class="inputbox col-sm-2">
                            <span class="Txtspan">Last Purc Rate</span>
                        ...
                        <div class="inputbox col-sm-1">
                            ...
                            <input  type="text" name="TxtStockQty" id="TxtStockQty">
                        </div>
                        <div class="inputbox col-sm-2">
                    ...
                    <option value="5">NEW YORK</option> --}}
                        ...
                        <button name="" id="" class="btn btn-info col-sm-1" role="button"><i
                                class="fab fa-plus text-white"></i> Fill</button>
                        <div class="inputbox col-sm-1 ml-1">
                ...
                <div class="card-body">
                    <div class="row py-1">
                        ...
                        <div class="form-check form-check-inline">
                            ...
                            <div class="CheckBox1">
                                <label class="input-group text-info ml-2 mt-2">
                                    <input  type="checkbox" name="ChkAdvancePayment" id="ChkAdvancePayment"
                                        value=""> Advance Payment
                                </label>
                            </div>
                            {{-- <label class="form-check-label  mx-1">
                                <input class="form-check-input " type="checkbox" onclick="" name="ChkCompanyHeading"
                                    id="ChkCompanyHeading" value=""> Company Heading
                            </label> --}}

                            {{-- <label class="form-check-label text-info mx-1">
                                <input class="form-check-input " type="checkbox" onclick="" name="ChkAdvancePayment"
                                    id="ChkAdvancePayment" value=""> Advance Payment
                            </label> --}}

                        </div>
                        <div class="inputbox col-sm-1 ml-auto">
                            <span class="Txtspan" for="TxtTotDrAmount">Total</span>
                        ...
                        <div class="inputbox col-sm-3 clearfix">
                            <input type="text" id="TxtTotInvAmt" name="TxtTotInvAmt"
                                class=" col-sm-3 float-left ml-2">
                            <input type="text" id="TxtTotBankCharges" name="TxtTotBankCharges"
                                class=" col-sm-3 float-left ml-2">
                            <input type="text" id="TxtTotAmount" name="TxtTotAmount"
                                class=" col-sm-3  ml-2">
                    ...
                    <div class="row py-2">
                        ...
                        <div class="inputbox col-md-2 ml-2">
                    ...
                    <div class="row py-2">
                        <div class="mx-auto">
                            ...
                            <a name="CmdSave" id="CmdSave" class="btn btn-success" role="button"><i
                                    class="fa fa-file-image text-white" aria-hidden="true"></i> Save</a>
                            ...
                            <a name="" href="/home" class="btn btn-danger" role="button"><i
                                    class="fas fa-door-open  text-whiye fa-fw"></i> Exit</a>
                        </div>
                    </div>
                </div>
            </div>
