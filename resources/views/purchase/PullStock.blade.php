    ...
    <div class="col-lg-12 pt-3 ">
        <div class="card">
            <div class="card-header">
                <h2 class=" text-blue text-bold">Pull Stock</h2>
            </div>
            <div class="card-header">
                ...
                <div class="row">
                    ...
                    <div class="  ml-5 ">
                        &nbsp; <strong>Charge # :&nbsp;</strong> <label class="Charge text-blue" for="TxtInvoiceNo"><input
                                type="text" name="TxtInvoiceNo" class="form-control" style="width: 80px; margin-top:-5px"
                    ...
                    <div class="ml-5">
                        <strong>Workuser&nbsp;</strong> <label class="VSN text-blue" for="LblWorkUser"></label>
                    </div>
            ...
            <div class="card-body">
                <div class="col-lg-12 py-2">
                    ...
                    <div class="row">
                        ...
                        <input hidden value="" type="text" id="TxtEventNo" name="TxtEventNo">
                        <input hidden value="" type="text" id="TxtQuoteNO" name="TxtQuoteNO">
                        <input hidden value="" type="text" id="TxtVSNNo" name="TxtVSNNo">
                        <input hidden value="" type="text" id="TxtChargeNO" name="TxtChargeNO">


                        <div class="inputbox col-sm-2 py-2">
                            <input value="" type="date" id="TxtPullDate" name="TxtPullDate">
                            <span> Pull Date </span>
                        </div>

                        <div class="inputbox col-sm-2 py-2">
                            <input value="" type="time" id="TxtPullTime" name="TxtPullTime">
                            <span> Pull Time </span>
                        </div>

                        <input hidden value="" type="text" id="TxtActCode" name="TxtActCode">

                        <div class="inputbox col-sm-4 py-2">
                            <input value="" type="text" id="TxtActName" name="TxtActName">
                            <span>Customer</span>
                        </div>

                        <input hidden value="" type="text" id="TxtGodownCode" name="TxtGodownCode">

                        <div class="inputbox col-sm-3 py-2">
                            <input value="" type="text" id="TxtGodownName" name="TxtGodownName">
                            <span>Location</span>
                        </div>

                        <input hidden value="" type="text" id="TxtPrefix" name="TxtPrefix">
                        <div class="col-sm-1"></div>
                        <label class="col-sm-1 mt-3" id="Label23">vessel: </label>
                        <label class="col-sm-1 mt-3" id="LblVesselName">vessel name</label>
                        ...
                        <a name="CmdBillingInformation" id="CmdBillingInformation" class="btn btn-info col-sm-2 mt-2 mb-2"
                            role="button">Billing Information</a>
