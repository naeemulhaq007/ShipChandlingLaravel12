...
@section('title', 'Fill-Not-Delivered')
    ...
    <div class="col-lg-12 pt-3 ">
        <div class="card">
            <div class="card-header">
                <h2 class=" text-blue text-bold">Fill Not Delivered</h2>
            </div>
            <div class="card-header">
                ...
                <div class="row">
                    ...
                    <div class="ml-5">
                        <strong>Workuser :&nbsp;</strong> <label class="VSN text-blue" for="VSN"></label>
                    </div>

                    <div class="  ml-5 ">
                        /&nbsp; <strong>Charge # :&nbsp;</strong> <label class="event_no text-blue" for="event_no"></label>

                    </div>
                    <div class="  ml-5 ">
                        /&nbsp; <strong>Charge No. # :&nbsp;</strong> <label class="Charge text-blue" for="Charge"><input
                                type="text" name="ChargeNo" class="form-control" style="width: 80px; margin-top:-5px"
                                id="TxtChargeNO" value="{{ $PONO }}"></label>
                    </div>
                    <div class="  ml-5 ">
                        /&nbsp; <strong>Quote # :&nbsp;</strong> <label class="Charge text-blue" for="Charge"><input
                                type="text" name="ChargeNo" class="form-control" style="width: 80px; margin-top:-5px"
                                id="TxtQuoteNO" value="{{ $PONO }}"></label>

                    </div>

                    <div class="  ml-5 ">
                        /&nbsp; <strong>VSN # :&nbsp;</strong> <label class="Charge text-blue" for="Charge"><input
                                type="text" name="ChargeNo" class="form-control" style="width: 80px; margin-top:-5px"
                                id="TxtVSNNo" value="{{ $PONO }}"></label>

                    </div>
                    <div class="  ml-5 ">
                        /&nbsp; <strong>Event # :&nbsp;</strong> <label class="Charge text-blue" for="Charge"><input
                                type="text" name="ChargeNo" class="form-control" style="width: 80px; margin-top:-5px"
                                id="TxtEventNo" value="{{ $PONO }}"></label>

                    </div>

                    <div class="  ml-5 mr-5 ">
                        /&nbsp; <strong>Invoice # :&nbsp;</strong> <label class="Charge text-blue" for="Charge"><input
                                type="text" name="ChargeNo" class="form-control" style="width: 80px; margin-top:-5px"
                                id="TxtInvoiceNo" value="{{ $PONO }}"></label>
                    </div>
            ...
            <div class="card-body">
                <div class="col-lg-12 py-2">
                    ...
                    <div class="row">
                        <input hidden value="" type="date" id="TxtDatefrom" name="TxtDatefrom">

                        <input hidden value="" type="date" id="TxtDateTo" name="TxtDateTo">
                        <input hidden value="" type="buttton" id="Button1" name="Button1">
                        <input hidden value="" type="text" id="TxtActCodeNew" name="TxtActCodeNew">



                        <div class="inputbox col-sm-2 py-1">
                            <input value="" type="date" id="TxtDispatchDate" name="TxtDispatchDate">
                            <span> Dispatch Date</span>
                        </div>

                        <div class="inputbox col-sm-2 py-1">
                            <input value="" type="time" id="TxtDispatchTime" name="TxtDispatchTime">
                            <span> Dispatch Time</span>
                        </div>

                        <div class="CheckBox1">
                            <label class="input-group text-info ml-2 mt-2">
                                <input class="mr-2" id="ChkSevenSeasNorwayAS" value="" name="ChkSevenSeasNorwayAS"
                                    type="checkbox">Seven Seas
                                Norway As
                            </label>
                        </div>

                        <div class="CheckBox1">
                            <label class="input-group text-info ml-3 mt-2">
                                <input class="mr-2" id="ChkSevenSeasDelivery" value=""
                                    name="ChkSevenSeasDelivery" type="checkbox">Seven Seas
                                Delivery
                            </label>
                        </div>

                        <input hidden value="" type="number" id="TxtActCode" name="TxtActCode">


                        <div class="inputbox col-sm-4 py-1 ml-2">
                            <input value="" type="number" id="TxtActName" name="TxtActName">
                            <span> Customer</span>
                        </div>

                        <a name="Button9" id="Button9" class="btn btn-info mt-1 mb-2" role="button"><i
                                class="fa fa-search mr-1" aria-hidden="true"></i>
                        </a>

                        <input hidden value="" type="number" id="TxtGodownCode" name="TxtGodownCode">


                        <div class="inputbox col-sm-2 py-2">
                            <input value="" type="number" id="TxtGodownName" name="TxtGodownName">
                            <span> Location</span>
                        </div>

                        <div class="inputbox col-sm-2 py-2">
                            <input value="" type="number" id="TxtAtten" name="TxtAtten">
                            <span> Attend.</span>
                        </div>

                        <label class="col-sm-1" id="Label23">Vessel</label>
                        <label class="col-sm-1" id="LblVesselName">Vessel Name</label>
                        <input hidden id="ChkDirectDelivery" type="checkbox" name="ChkDirectDelivery">
                        <input hidden id="TxtVendorActCode" type="text" name="TxtVendorActCode">
                        <input hidden id="CmbVendorName" type="dropdown" name="CmbVendorName">



                        <div class="inputbox col-sm-2 py-2">
                            <input value="" type="text" id="TxtRefNo" name="TxtRefNo">
                            <span>Cust. Ref. No.</span>
                        </div>

                        <div class="inputbox col-sm-2 py-2">
                            <input value="" type="text" id="TxtTerms" name="TxtTerms">
                            <span>Terms</span>
                        </div>

                        <div class="inputbox col-sm-2 py-2">
                            <input value="" type="text" id="TxtSearch" name="TxtSearch">
                            <span>Search</span>
                        </div>

                        <div class="inputbox col-sm-2 py-2">
                            <input value="" type="date" id="TxtOrderDate" name="TxtOrderDate">
                            <span>Invoice Date</span>
                        </div>

                        <div class="inputbox col-sm-2 py-2">
                            <input value="" type="date" id="TxtDeliveryDate" name="TxtDeliveryDate">
                            <span>Delivery Date</span>
                        </div>

                        <div class="inputbox col-sm-2 py-2">
                            <input value="" type="dropdown" id="CmbPort" name="CmbPort">
                            <span>Port</span>
                        </div>

                        <div class="inputbox col-sm-2 py-2">
                            <input value="" type="time" id="TxtTime" name="TxtTime">
                            <span>Delivery Time</span>
                        </div>

                        <div class="inputbox col-sm-2 py-2">
                            <input value="" type="text" id="TxtLocation" name="TxtLocation">
                            <span>Location</span>
                        </div>

                        <div class="inputbox col-sm-2 py-2">
                            <input value="" type="text" id="TxtDeliveryOrderNo" name="TxtDeliveryOrderNo">
                            <span>Delivery Order #</span>
                        </div>

                        <div class="inputbox col-sm-2 py-2">
                            <input value="" type="text" id="TxtDepartment" name="TxtDepartment">
                            <span>Department</span>
                        </div>

                        <div class="inputbox col-sm-2 py-2">
                            <input value="" type="text" id="TxtGeneralNotes" name="TxtGeneralNotes">
                            <span>General Vessel Note</span>
                        </div>

                        <input hidden value="" type="buttton" id="CmdBillingInformation"
                            name="CmdBillingInformation">

                        <div class="inputbox col-sm-2 py-2">
                            <input value="" type="dropdown" id="TxtStatus" name="TxtStatus">
                            <span>Status</span>
                        </div>

                        <div class="inputbox col-sm-2 py-2">
                            <input value="" type="text" id="TextBox1" name="TextBox1">
                            <span>Department</span>
                        </div>

                        <input hidden value="" type="text" id="TxtDepartmentCode" name="TxtDepartmentCode">
                        <input hidden value="" type="checkbox" id="ChkApplyPrice" name="ChkApplyPrice">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="row py-2 ml-1">
                    <a name="" id="selectAll" class="btn btn-info col-sm-1 form-control mx-1"
                        role="button">Select
                        All</a>
