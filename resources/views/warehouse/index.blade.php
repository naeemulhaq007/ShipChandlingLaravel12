...
<div style="clear: both">
            ...
            <table  style="margin-left: 20%"class="table table-striped table-inverse table-responsive">
                <thead class="thead-inverse">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td ><a href="/warehouse/update/{{$item->Id}}">{{$item->Id}}</a></td>
    ...
    <div class="col-md-12">
        ...
        <div class="row">
            ...
            <div class="col-sm-5">
        <input style="margin-bottom: 2%" type="text" required name="warehouse" class="form-control"  id="warehouse"  placeholder="">
            </div>
        </div>
