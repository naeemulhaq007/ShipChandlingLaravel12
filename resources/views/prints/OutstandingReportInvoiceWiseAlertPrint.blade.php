            ...
            <div class="col-sm-5">
                ...
                <div class="row mt-2">
                    <div class="col-sm-8 card text-center text-blue">
                        <h4>Outstanding Invoice Alert</h4>
                    </div>
                        ...
                        @foreach ($table->groupBy('CustomerName') as $CustomerName => $CustomeItems)
                            ...
                            @foreach ($CustomeItems as $item)
                                ...
                                <tr class="customer-details {{ $targetId }}" style="display: none;">
                                    ...
                                    <td>{{ $item->DueDate ? \Carbon\Carbon::parse(today())->diffInDays(\Carbon\Carbon::parse($item->DueDate)) . ' Days' : '' }}
                                    </td>
                                    <td>{{ $item->InvDate ? \Carbon\Carbon::parse(today())->diffInDays(\Carbon\Carbon::parse($item->InvDate)) . ' Days' : '' }}
                                    </td>
