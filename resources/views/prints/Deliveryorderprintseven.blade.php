...
@section('title', 'SEVEN-SEAS-Delivery-Order-Print')
...
<div class="">
    ...
    <div class="col-sm-5">
         ...
         <div class="row pb-2">
            <div class="col-sm-12">
            <h2><strong> SEVEN SEAS SHIP CHANDLERS (L.L.C) </strong>
            </h2>
        </div>
    </div>
    <div class="row">
         <div class="col-sm-12">
            <h6>Plot 598-668, Dubai Investment Park - 1 <br> Off Emirates Road, P.O.Box 5592, Dubai, U.A.E</h6>
         </div>
        </div>
            <div class="row ">
                 <div class="col-sm-12">
                <h6>Tele : +971 4 8033 333  Fax : +971 4 8033 444</h6>
             </div>
            </div>
            <div class="row ">
                 <div class="col-sm-12">
                 <h6>E-mail : <a href="mailto:supply.uae@sevenseasgroup.com">supply.uae@sevenseasgroup.com </a><br>Website : <a href="www.sevenseasgroup.com">www.sevenseasgroup.com</a></h6>
            </div>
         </div>
    ...
    <div class="col-sm-6">
         <div class="row my-5 float-right col-sm-8">
        </div>
