...
@section('title', 'Customer-Reconciliation-Report')
        ...
        <div class="col-lg-12 py-3">
            ...
            <div class="card ">
                <div class="card-header" style="background-color: #eeeeee">
                    <div class="row">
                        <h3 class="mx-auto"><b>Customer Reconciliation Report</b></h3>
                ...
                <div class="card-body">
                        ...
                        <div class="col-sm-6">
                            <div class="row">
                                ...
                                <div class="inputbox col-sm-10">
                                    <span class="Txtspan" id="">Account</span>
                                    <select class="" name="TxtActName" id="TxtActName">
                                        <option></option>
                                    </select>
                    ...
                    <div class="row py-2">
                        <div class="col-sm-6">
                            <div class="row">
                                ...
                                <div class="inputbox col-sm-10">
                                    <span class="Txtspan" id="">Des.</span>
                                    <select class="" name="TxtDes" id="TxtDes">
                                        <option></option>
                                    </select>
                                </div>
                                ...
                                <div class="CheckBox1">
                                    <label class="input-group text-info mt-2 ml-2 ">
                                        <input class=" " type="checkbox" name="ChkDesALL" id="ChkDesALL" checked
                                            value=""> ALL
                                    </label>
                                </div>
                        ...
                        <div class="col-sm-3">
                            <div class="row">
                                <div class="inputbox col-sm-8 py-2">
                                    <span class="Txtspan" id="">Reconciled</span>
                                    <select class="" name="CmbReconciled" id="CmbReconciled">
                    ...
                    <div class="row">
                        ...
                        <div class="inputbox col-sm-2 py-2">
                            <input class="" type="text" name="TxtReconDateFrom" id="TxtReconDateFrom">
                            <span class="" id="">Recon. From</span>
                        </div>

                        <div class="inputbox col-sm-2 py-2">
                            <input class="" type="text" name="TxtReconDateTo" id="TxtReconDateTo">
                            <span class="" id="">To</span>
                        </div>
                    ...
                    <div class="row py-2">
                        <a name="Button3" id="CmdGenerate" class="btn btn-dark mx-1" role="button"><i
                                class="fas fa-file"></i> Generate</a>

                        <a name="BtnFill" id="CmdPrint" class="btn btn-primary mx-1" role="button"><i
                                class="fas fa-print"></i> Print Preview</a>
