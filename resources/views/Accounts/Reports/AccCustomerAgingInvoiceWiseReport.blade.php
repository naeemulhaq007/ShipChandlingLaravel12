...
@section('title', 'Customer-Aging-Report-Invoice-Wise')
        ...
        <div class="col-lg-12 py-3">
            ...
            <div class="card ">
                <div class="card-header" style="background-color: #eeeeee">
                    <div class="row">
                        <h3 class="mx-auto"><b>Customer Aging Report Invoice Wise</b></h3>
                ...
                <div class="card-body">
                    ...
                    <a name="Button4" id="Button4" role="button"></a>
                    ...
                    <div class="row py-2">
                        ...
                        <div class="rdform row mx-5 mt-2">
                            ...
                            <input id="OptDetail" type="radio" class="rainput" autocomplete="off" name="hopping2"
                                value="" checked>
                            <label class="ralabel mx-2" for="OptDetail"><span></span>Detailed Report</label>

                            <input id="OptSummary" type="radio" class="rainput" autocomplete="off" name="hopping2"
                                value="">
                            <label class="ralabel  mx-2" for="OptSummary"><span></span>Summary Report</label>
