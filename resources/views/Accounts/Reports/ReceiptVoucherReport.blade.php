...
@section('title', 'Receipt-Voucher-Report')
        ...
        <div class="col-lg-12 py-3">
            ...
            <div class="card ">
                <div class="card-header" style="background-color: #eeeeee">
                    <div class="row">
                        <h3 class="mx-auto"><b>Receipt Voucher Report</b></h3>
                ...
                <div class="card-body">
                        ...
                        <div class="col-sm-6">
                            <div class="row">
                                ...
                                <div class="inputbox col-sm-1">
                                    <input class="" type="text" name="TxtAccountCode" id="TxtAccountCode"
                                ...
                                <div class="inputbox col-sm-9">
                                    <input class="" readonly type="text" name="TxtAccountTitle"
                                        id="TxtAccountTitle">
                                    <span class="" id="">Account Code</span>
                                </div>

                                <a name="CmdActCode" id="CmdActCode" class="btn btn-info" data-target="#chart"
                    ...
                    <div class="row py-2">
                        <div class="col-sm-6">
                            <div class="row">
                                ...
                                <div class="inputbox col-sm-1">
                                    <input type="text" name="TxtPartyAccountCode" id="TxtPartyAccountCode">
                                    <span class="" id=""></span>
                                </div>

                                <div class="inputbox col-sm-9">
                                    <input type="text" readonly name="TxtPartyAccountTitle" id="TxtPartyAccountTitle">
                                    <span class="" id="">Party Account Code</span>
                                </div>

                                <a name="CmdPartyActCode" id="CmdPartyActCode" class="btn btn-info" data-target="#chart"
                                    data-toggle="modal" role="button"><i class="fa fa-search" aria-hidden="true"></i></a>

                                <div class="CheckBox1">
                                    <label class="input-group text-info mt-2 ml-2">
                                        <input class=" " type="checkbox" name="ChkPartyActCode" id="ChkPartyActCode"
                                            checked value=""> ALL
                                    </label>
                                </div>
                        ...
                        <div class="col-sm-6">
                            <div class="row">
                                <div class="inputbox col-sm-10">
                                    <span class="Txtspan" id="">Cheque No.</span>
                                    <select class="" name="TxtChequeNo" id="TxtChequeNo">
                                ...
                                <div class="CheckBox1">
                                    <label class="input-group text-info mt-2 ml-2">
                                        <input class="" type="checkbox" name="ChkChequeNo" id="ChkChequeNo"
                                            checked value=""> ALL
                                    </label>
                                </div>
                            </div>
                    ...
                    <div class="row py-2 ">
                        ...
                        <div class="inputbox col-sm-2">
                            <input class="" type="text" name="TxtInvoiceNoFrom" id="TxtDateFrom">
                            <span class="" id="">Inv. No. From</span>
                        </div>

                        <div class="inputbox col-sm-2">
                            <input class="" type="text" name="TxtInvoiceNoTo" id="TxtDateTo">
                            <span class="" id="">To</span>
                        </div>

                        <div class="CheckBox1">
                            <label class="input-group text-info mt-2 ml-2 ">
                                <input class=" " type="checkbox" name="ChkInvAll" id="ChkInvAll" checked
                                    value=""> ALL
                            </label>
                        </div>
                        ...
                        <div class="col-sm-6">
                            <div class="row">
                                <div class="inputbox col-sm-10">
                                    ...
                                    <select class="" name="CmbVesselName" id="CmbVesselName">
                                        @foreach ($VesselSetup as $VesselSetupitem)
                                            <option value="{{ $VesselSetupitem->VesselName }}">
                                                {{ $VesselSetupitem->VesselName }}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="CheckBox1">
                                    <label class="input-group text-info mt-2 ml-2 ">
                                        <input class=" " type="checkbox" name="ChkVesselALL" id="ChkVesselALL"
                                            checked value=""> ALL
                                    </label>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="CheckBox1">
                            <label class="input-group text-info mt-2 ml-2 ">
                                <input class=" " type="checkbox" name="ChkCompanyHeading" id="ChkCompanyHeading"
                    ...
                    <div class="row py-2">
                        <a name="CmdGenerate" id="CmdGenerate" class="btn btn-success mx-1" role="button"><i
            ...
            <div class="row">
                ...
                <div class="col-sm-12">
                    <div class="rounded shadow">
                        <table class="table " id="DG2" style="width:100%">
    ...
    @section('js')
        ...
        <script>
            $(document).ready(function() {
                ...
                var Getact = $('#TxtAccountCode').val();
                if (Getact !== 0 || Getact !== '') {
                    handleTxtActCodeBlur();
                }

                function handleTxtActCodeBlur() {
                    var txtActCode = document.getElementById('TxtAccountCode');
            ...
            $(document).ready(function() {
                ...
                $('#CmdGenerate').click(function(e) {
                    e.preventDefault();
                    // var ACTcode = $('#TxtAccountCode').val().trim();
                    // if (ACTcode.length === 0) {
                    //     $('#TxtAccountCode').focus();
                    //     return;
                    // }

                    if (($('#ChkActCode').prop('checked') == false && $('#TxtAccountCode').val() == 0)) {
                        $('#TxtAccountCode').Focus();
                        return;
                    }

                    if ($('#ChkPartyActCode').prop('checked') == false && $(('#TxtPartyAccountCode').val() ==
                            0)) {
                        $('#TxtPartyAccountCode').Focus();
                        return;
                    }

                    if ($('#ChkChequeNo').prop('checked') == false && $(('#TxtChequeNo').val() == 0)) {
                        $('#TxtChequeNo').Focus();
                        return;
                    }
                    ...
                    // console.log(Qry);
                    var Qry = 'VoucherDate >="' + MDateFrom + '" and VoucherDate <= "' + MDateTo + '"';

                    if (!$("#ChkActCode").is(":checked")) {
                        if (Qry !== "") Qry += " and ";
                        Qry += "ActCashCode = " + $('#TxtAccountCode').val() + "";
                    }
                    // console.log(Qry);

                    if (!$("#ChkPartyActCode").is(":checked")) {
                        if (Qry !== "") Qry += " and ";
                        Qry += "ActCode='" + $('#TxtPartyAccountCode').val() + "'";
                    }
                    // console.log(Qry);

                    if (!$("#ChkChequeNo").is(":checked")) {
                        if (Qry !== "") Qry += " and ";
                        Qry += "ChequeNo='" + $('#TxtChequeNo').val() + "'";
                    }

                    // console.log(Qry);
                    if (!$("#ChkInvAll").is(":checked")) {
                        if (Qry !== "") Qry += " and ";
                        Qry += "ClientOrderNo >=" + ($('#TxtInvoiceNoFrom').val()) + " and ClientOrderNo <=" +
                            $('#TxtInvoiceNoTo').val();;
                    }
                    // console.log(Qry);

                    if (!$("#ChkVesselALL").is(":checked")) {
                        if (Qry !== "") Qry += " and ";
                        Qry += "VesselName='" + $('#CmbVesselName').val() + "'";
                    }
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            console.log(response);
                            if (response.MNetAmount) {
                                $('#TxtTotalAmount').val(parseFloat(response.MNetAmount).toFixed(
                                    2));

                            }

                            if (response.ReceiptVouchers) {

                                if (response.ReceiptVouchers.length > 0) {
                                    var ReceiptVouchers = response.ReceiptVouchers;
                                    ...
                                    currency.forEach(function(item) {
                                        ...
                                        createCell(item.VoucherDate);
                                        createCell(item.VoucherNo);
                                        createCell(item.AcName3);
                                        createCell(item.CashName);
                                        createCell(item.TransType);
                                        createCell(item.ChequeNo);
                                        createCell(item.ChequeDate);
                                        createCell(item.ClientOrderNo);
                                        createCell(item.Des);
