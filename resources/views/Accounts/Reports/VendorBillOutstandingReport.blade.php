...
@section('title', 'Vendor-Bill-Outstanding-Report')
        ...
        <div class="col-lg-12 py-3">
            ...
            <div class="card ">
                <div class="card-header" style="background-color: #eeeeee">
                    <div class="row">
                        <h3 class="mx-auto"><b>Vendor Bill Outstanding Report</b></h3>
                ...
                <div class="card-body">
                        ...
                        <div class="col-sm-6">
                            <div class="row">
                                ...
                                <div class="inputbox col-sm-1">
                                    <input type="text" name="txtVendorCode" id="txtVendorCode">
                                    <span class="" id=""></span>
                                </div>

                                <div class="inputbox col-sm-9">
                                    <input class="" readonly type="text" name="txtVendorname" id="txtVendorname">
                                ...
                                <div class="CheckBox1">
                                    ...
                                    <label class="input-group text-info mt-2 ml-2">
                                        <input class=" " type="checkbox" name="ChkAllVendor" id="ChkAllVendor" checked
                                            value=""> ALL
                                    </label>
                                </div>
                    ...
                    <div class="row py-2">
                        <div class="rdform row mx-5 mt-2">
                            ...
                            <label class="ralabel mx-2" for="OptUnclearInvoice"><span></span>Outstanding</label>

                            <input id="OptClearInvoices" type="radio" class="rainput" autocomplete="off"
                                name="hopping2" value="">
                            <label class="ralabel  mx-2" for="OptClearInvoices"><span></span>Paid</label>

                            <input id="OptAll" type="radio" class="rainput" autocomplete="off"
                                name="hopping2" value="">
                            <label class="ralabel  mx-2" for="OptAll"><span></span>All Bills</label>
                    ...
                    <div class="row py-2">
                        <a name="CmdShow" id="CmdShow" class="btn btn-success mx-1" role="button"><i
