        ...
        <div class="col-lg-12 py-3">
            ...
            <div class="card ">
                <div class="card-header" style="background-color: #eeeeee">
                    <div class="row">
                        <h3 class="mx-auto"><b>Aging Report</b></h3>
                ...
                <div class="card-body">
                    ...
                    <div class="row py-2">
                        <a name="CmdGenerate" id="CmdGenerate" class="btn btn-dark mx-1" role="button"><i
                                class="fas fa-file"></i> Generate OLD</a>
        ...
        <script>
            ...
            $(document).ready(function() {
                ...
                $('#CmdGenerate').click(function(e) {
                    ...
                    var TxtActCode = $('#TxtActCode').val();
                    var TxtActName = $('#TxtActName').val();
                    var ChkAll = $('#ChkAll').val();
                    var ChkCompanyHeading = $('#ChkCompanyHeading').val();
                    e.preventDefault();
                    ajaxSetup();
                    $.ajax({
                        type: "post",
                        url: "{{ route('AccAgingGen') }}",
                        data: {
                            TxtDateTo,
                            TxtActCode,
                            TxtActName,
                            ...
                            if (response.Message == 'Saved') {
                                ...
                                if (response.currencyysetup.length > 0) {
                                    ...
                                    currency.forEach(function(item) {
                                        ...
                                        createCell(item.TxtDateTo);
                                        createCell(item.TxtActCode);
                                        createCell(item.TxtActName);
                                        createCell(item.ChkAll);
                                        createCell(item.ChkCompanyHeading);
                                    });
                                    dblcvkui()
                                }
                            }
