...
@section('title', 'Aging-Payable-Report-Invoice-Wise')
        ...
        <div class="col-lg-12 py-3">
            ...
            <div class="card ">
                <div class="card-header" style="background-color: #eeeeee">
                    <div class="row">
                        <h3 class="mx-auto"><b>Aging Payable Report Invoice Wise</b></h3>
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="inputbox col-sm-2 py-2">
                            <input class="" type="date" name="TxtRtnDate" id="TxtRtnDate">
                            <span class="" id="">Rtn Date</span>
                        </div>
                        ...
                        <div class="col-sm-8">
                            <div class="row">
                                ...
                                <div class="inputbox col-sm-9">
                                    <span class="Txtspan" id="">A/C. Head</span>
