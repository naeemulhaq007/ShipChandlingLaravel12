...
@section('title', 'Outstanding-Report-Invoice-Wise')
...
@section('content')
        ...
        <div class="col-lg-12 py-3">
            ...
            <div class="card ">
                <div class="card-header" style="background-color: #eeeeee">
                    <div class="row">
                        <h3 class="mx-auto"><b>Outstanding Report Invoice Wise</b></h3>
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="inputbox col-sm-2 py-2">
                            <input class="" type="date" name="TxtInvDateFrom" id="TxtInvDateFrom">
                            <span class="" id="">Inv. Date From</span>
                        </div>

                        <div class="inputbox col-sm-2 py-2">
                            <input class="" type="date" name="TxtInvDateTo" id="TxtInvDateTo">
                            <span class="" id="">To</span>
                        </div>

                        <div class="CheckBox1 py-2">
                            <label class="input-group text-info mt-2 ml-2 ">
                                <input class=" " type="checkbox" name="ChkInvDAteAll" id="ChkInvDAteAll" checked
                                    value=""> ALL
                            </label>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="inputbox col-sm-2 py-2">
                            <input class="" type="text" name="TxtDateFrom" id="TxtDateFrom">
                            <span class="" id="">Order Date From</span>
                        </div>

                        <div class="inputbox col-sm-2 py-2">
                            <input class="" type="text" name="TxtDateTo" id="TxtDateTo">
                            <span class="" id="">To</span>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="inputbox col-sm-2 py-2">
                            <input class="" type="text" name="TxtInvoiceNoFrom" id="TxtInvoiceNoFrom">
                            <span class="" id="">Inv. No. From</span>
                        </div>

                        <div class="inputbox col-sm-2 py-2">
                            <input class="" type="text" name="TxtInvoiceNoTo" id="TxtInvoiceNoTo">
                            <span class="" id="">To</span>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="inputbox col-sm-2 py-2">
                            <input class="" type="text" name="TxtOverDaysFrom" id="TxtOverDaysFrom">
                            <span class="" id="">Over Days From</span>
                        </div>

                        <div class="inputbox col-sm-2 py-2">
                            <input class="" type="text" name="TxtOverDaysTo" id="TxtOverDaysTo">
                            <span class="" id="">To</span>
                        </div>

                        <div class="CheckBox1 py-2">
                            <label class="input-group text-info mt-2 ml-2 ">
                                <input class=" " type="checkbox" name="ChkAllOverDays" id="ChkAllOverDays" checked
                                    value=""> ALL
                            </label>
                        </div>
                    ...
                    <div class="row">
                            ...
                            <div class="row">
                                <div class="inputbox col-sm-9 py-2">
                                    ...
                                    <select class="" name="CmbTerms" id="CmbTerms">
                                        <option>N 7 Days</option>
                                        <option>N 15 Days</option>
                                        <option>N 30 Days</option>
                                        <option>N 45 Days</option>
                                        <option>N 60 Days</option>
                                        <option>N 90 Days</option>
                                        <option>CASH</option>
                                        <option>FOR CHEQUE</option>
                                    </select>
                                </div>
                        ...
                        <div class="inputbox col-sm-2 py-2">
                            <span class="Txtspan" id="">Country</span>
                            <select class="" name="CmbCountry" id="CmbCountry">
                        ...
                        <div class="CheckBox1 py-2">
                            <label class="input-group text-info mt-2 ml-2">
                                <input class="" type="checkbox" name="ChkAllCountry" id="ChkAllCountry" checked
                                    value=""> ALL
                            </label>
                        </div>
                    ...
                    <input hidden class="" type="checkbox" name="ChkBill" id="ChkBill">
                    <input hidden class="" type="date" name="TxtBackLogDate" id="TxtBackLogDate">
                    <a hidden name="CmdShow" id="CmdShow" role="button"></a>
                    ...
                    <div class="row py-2">
                        <div class="col-sm-6">
                            <div class="row">
                                ...
                                <input hidden class="" type="text" name="TxtActCode" id="TxtActCode"
                                    value="">

                                <div hidden class="inputbox col-sm-1">
                                    <input class="" type="text" name="TxtCustomerCode" id="TxtCustomerCode"
                                        value="">
                                    <span class="" id=""></span>
                                ...
                                <div class="inputbox col-sm-10">
                                    ...
                                    <select class="" name="CmbCustomer" id="CmbCustomer">
                                        <option></option>
                                    </select>

                                </div>

                                <a name="Button2" id="Button2" class="btn btn-info" data-target="#chart"
                                    data-toggle="modal" role="button"><i class="fa fa-search"
                    ...
                    <div class="row py-2">
                        <div class="col-sm-6">
                            <div class="row">
                                ...
                                <div hidden class="inputbox col-sm-1">
                                    <input class="" type="text" name="TxtVesselCode" id="TxtVesselCode"
                                ...
                                <div class="inputbox col-sm-10">
                                    ...
                                    <select class="" name="CmbVessel" id="CmbVessel">
                                        <option></option>
                                    </select>
                                </div>


                                <a name="Button1" id="Button1" class="btn btn-info" data-target="#chart"
                                    data-toggle="modal" role="button"><i class="fa fa-search"
                                        aria-hidden="true"></i></a>
                                ...
                                <div class="CheckBox1">
                                    <label class="input-group text-info mt-2 ml-2 ">
                                        <input class=" " type="checkbox" name="AllVessel" id="AllVessel" checked
                                            value=""> ALL
                                    </label>
                                </div>
                    ...
                    <input hidden class=" " type="checkbox" name="CHKBANKDTL" id="CHKBANKDTL" checked
                        value="">

                    <div class="row">

                        <div class="inputbox col-sm-2 py-2">
                            <input class="" type="text" name="TxtDueDateFrom" id="TxtDueDateFrom">
                            <span class="" id="">Due Date From</span>
                        </div>

                        <div class="inputbox col-sm-2 py-2">
                            <input class="" type="text" name="TxtDueDateTo" id="TxtDueDateTo">
                            <span class="" id="">To</span>
                        </div>
                        ...
                        <div class="col-sm-3">
                            <div class="row">
                                <div class="inputbox col-sm-8">
                                    ...
                                    <select class="" name="CmbStatus" id="CmbStatus">
                                        {{-- @foreach ($GodownSetup as $Godown)
                                            <option value="{{ $Godown->GodownCode }}">{{ $Godown->GodownName }}</option>
                                            @endforeach --}}
                                    </select>
                    ...
                    <div class="row py-2">
                        <div class="CheckBox1">
                            <label class="input-group text-info mt-2 ml-2">
                                <input class="" type="checkbox" name="CHKBANKDTL" id="CHKBANKDTL" checked
                                    value=""> Show Bank Detail
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="row py-2">
                        ...
                        <div class="rdform row mx-5 mt-2">
                            ...
                            <input id="OptUnclearInvoice" type="radio" class="rainput" autocomplete="off"
                                name="hopping22" value="" checked>
                            <label class="ralabel mx-2" for="OptUnclearInvoice"><span></span>Unpaid Invoices</label>

                            <input id="OptClearInvoices" type="radio" class="rainput" autocomplete="off"
                                name="hopping22" value="">
                            <label class="ralabel  mx-2" for="OptClearInvoices"><span></span>Paid Invoices</label>

                            <input id="OptAll" type="radio" class="rainput" autocomplete="off" name="hopping22"
                                value="">
                    ...
                    <div class="row py-2">
                        <a name="Button3" id="Button4" class="btn btn-success mx-1" role="button"><i
                                class="fas fa-file"></i> Show</a>

                        <a name="BtnFill" id="Button3" class="btn btn-primary mx-1" role="button"><i
    ...
    @section('css')
        ...
        <style>
            ...
            .rainput:nth-of-type(1):checked~.worm2 .worm__segment3 {
                transform: translateX(0.5em);
            }

            .rainput:nth-of-type(1):checked~.worm2 .worm__segment3:before {
                animation-name: hop1;
            }
            ...
            .rainput:nth-of-type(2):checked~.worm2 .worm__segment3 {
                transform: translateX(10.49em);
            }

            .rainput:nth-of-type(2):checked~.worm2 .worm__segment3:before {
                animation-name: hop2;
            }
            ...
            .rainput:nth-of-type(3):checked~.worm2 .worm__segment3 {
                transform: translateX(19.25em);
            }

            .rainput:nth-of-type(3):checked~.worm2 .worm__segment3:before {
                animation-name: hop3;
            }
