...
@section('title', 'Outstanding-Invoice-Alert-Report')
        ...
        <div class="col-lg-12 py-3">
            ...
            <div class="card ">
                <div class="card-header" style="background-color: #eeeeee">
                    <div class="row">
                        <h3 class="mx-auto"><b>Outstanding Invoice Alert Report</b></h3>
                ...
                <div class="card-body">
                    ...
                    <div class="row py-2 ">
                        ...
                        <div class="inputbox col-sm-2">
                            <input class="" type="date" name="TxtDate" id="TxtDateFrom">
                            <span class="" id="">Due Date</span>
                        </div>

                        <a name="BtnShow" id="BtnShow" class="btn btn-success ml-5 mb-1 mt-1" role="button"><i
                                class="fas fa-file"></i> Show</a>

                        <a name="BtnPrint" id="BtnPrint" class="btn btn-primary ml-2 mb-1 mt-1" role="button"><i
                                class="fas fa-print"></i> Print</a>

                        <a name="GunaGradientButton2" id="GunaGradientButton2" class="btn btn-danger ml-2 mb-1 mt-1" href="/" role="button"><i
