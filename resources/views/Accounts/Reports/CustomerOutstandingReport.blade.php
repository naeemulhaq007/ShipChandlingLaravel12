...
@section('title', 'Customer-Outstanding-Report')
        ...
        <div class="col-lg-12 py-3">
            ...
            <div class="card ">
                <div class="card-header" style="background-color: #eeeeee">
                    <div class="row">
                        <h3 class="mx-auto"><b>Customer Outstanding Report</b></h3>
                ...
                <div class="card-body">
                    ...
                    <div class="row py-2">
                        ...
                        <input hidden class="" type="text" name="TxtActCode" id="TxtActCode" value="">
                        ...
                        <div class="CheckBox1">
                            <label class="input-group text-info mt-2 ml-2 ">
                                <input class=" " type="checkbox" name="ChkAll" id="ChkAll" checked value="">
                                ALL
                            </label>
                        </div>
                    ...
                    <div class="row py-2">
                        <a hidden name="Button3" id="CmdGenerate" role="button"></a>

                        <a name="Button3" id="CmdGenerateNew" class="btn btn-dark mx-1" role="button"><i
                                class="fas fa-file"></i> Generate</a>

                        <a name="BtnFill" id="Button4" class="btn btn-primary mx-1" role="button"><i
