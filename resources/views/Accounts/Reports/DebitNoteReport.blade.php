        ...
        <div class="col-lg-12 py-3">
            ...
            <div class="card ">
                <div class="card-header" style="background-color: #eeeeee">
                    <div class="row">
                        <h3 class="mx-auto"><b>Debit Note Report</b></h3>
                ...
                <div class="card-body">
                    ...
                    <div class="row py-2">
                        <a name="Button1" id="Button1" class="btn btn-success mx-1" role="button"><i
                                class="fas fa-file"></i> Show</a>

                        <a name="CmdGenerate" id="CmdGenerate" class="btn btn-primary mx-1" role="button"><i
