        ...
        <div class="col-lg-12 py-3">
            ...
            <div class="card ">
                <div class="card-header" style="background-color: #eeeeee">
                    <div class="row">
                        <h3 class="mx-auto"><b>Expense Report</b></h3>
                ...
                <div class="card-body">
                    ...
                    <div class="row py-2">
                        <div class="col-sm-6">
                            <div class="row">
                                ...
                                <a name="Button5" id="Button5" class="btn btn-info" data-target="#chart"
                        ...
                        <div class="col-sm-6">
                            <div class="row">
                                ...
                                <div class="inputbox col-sm-10">
                                    <input type="text" readonly name="TxtActSearch" id="TxtActSearch">
                                    <span class="" id="">Party Account Code</span>
                                </div>

                                <div class="CheckBox1">
                                    <label class="input-group text-info mt-2 ml-2">
                                        <input class=" " type="checkbox" name="ChkActSearchAll" id="ChkActSearchAll"
                                            checked value=""> ALL
                                    </label>
                                </div>
                    ...
                    <div class="row py-2">
                        <a name="BtnFill" id="BtnFill" class="btn btn-success mx-1" role="button"><i
