        ...
        <div class="col-lg-12 pt-2">
            ...
            <div class="card mt-3">
                ...
                <div class="card-header">
                    <h3 class="text-bold text-center">Vendor Registration</h3>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-9">
                            <div class="row">
                                ...
                                <div class="inputbox">
                                    <input class="" readonly type="hidden" id="TxtActCodeLIAB" name="TxtActCodeLIAB">
                                </div>


                                <div class="inputbox col-sm-9 py-2">
                                    <input class="" type="text" id="TxtActNameLIAB" name="TxtActNameLIAB">
                                    <span id="">Liability A/c
                                    </span>
                                </div>

                                <a name="" id="Button15" class="btn btn-info mt-2 mb-2 col-sm-1 ml-2" href="#"
                                    role="button"><i class="fas fa-search"></i></a>

                                <a name="" id="CmdBill" class="btn btn-info mt-2 mb-2 col-sm-1 ml-2" href="#"
                                    role="button">Bill</a>
                    ...
                    <div class="row">
                        <div class="col-sm-9">
                            <div class="row">
                                ...
                                <div class="inputbox">
                                    <input class="" readonly type="hidden" id="TxtActCodeExp"
                                        name="TxtActCodeExp">
                                </div>
                                ...
                                <div class="inputbox col-sm-9 py-2">
                                    ...
                                    <span id="">Expenses A/c
                                    </span>
                                </div>

                                <a name="" id="Button18" class="btn btn-info mt-2 mb-2 col-sm-1 ml-2" href="#"
                                    role="button"><i class="fas fa-search"></i></a>

                                <a name="" id="CmdLedger" class="btn btn-info mt-2 mb-2 col-sm-1 ml-2" href="#"
                                    role="button">Ledger</a>
