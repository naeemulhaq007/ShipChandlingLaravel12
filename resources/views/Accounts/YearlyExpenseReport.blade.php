        ...
        <div class="col-lg-12 pt-2">
            ...
            <div class="card mt-3">
                ...
                <div class="card-header">
                    ...
                    <h3 class="text-bold text-center">Yearly Expense Report</h3>
                ...
                <div class="card-body">
                    ...
                    <div class="row py-2">
                        ...
                        <div class="inputbox col-sm-3">
                            <input id='TxtYear' type="text" class="" value="">
                    ...
                    <div class="row py-2">
                        ...
                        <a name="Button5" id="Button5" class="btn btn-info ml-1" href="#" role="button"><i
                                class="fas fa-search"></i></a>

                        <div class="CheckBox1">
                            <label class="input-group text-info mt-2 mx-3">
                                <input class="" type="checkbox" onclick="" name="ChkAll"
                                    id="ChkAll" value=""> All
                            </label>
                        </div>
                    ...
                    <div class="row py-3">
                        ...
                        <div class="CheckBox1">
                            <label class="input-group text-info mt-2 mx-3">
                                <input class="mr-2" type="checkbox" onclick="" name="ChkCompanyHeading"
                            ...
                            <a name="" id="" class="btn btn-warning mx-1" href="#" role="button"> <i
                                    class="fas fa-trash"></i> Delete</a>

                            <a name="" id="" class="btn btn-danger mx-1" href="#" role="button"><i
