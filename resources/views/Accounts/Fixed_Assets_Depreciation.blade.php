        ...
        <div class="col-lg-12 pt-2">
            ...
            <div class="card mt-3">
                ...
                <div class="card-header">
                    <h3 class="text-bold text-center">Fixed Assets Depreciation</h3>
                </div>
                ...
                <div class="inputbox col-sm-2">
                    <input id="TxtRefNo" class="" type="text">
                    <span>Ref.</span>

                </div>

                <div class="inputbox col-sm-2">
                    <input id="TxtDate" class="" type="date">
                    <span>Date</span>

                </div>

                <div class="inputbox col-sm-2">
                    <input id="TxtDateFrom" class="" type="date">
                    <span>From</span>

                </div>

                <div class="inputbox col-sm-2">
                    <input id="TxtDateTo" class="" type="date">
                    <span>To</span>

                </div>
                <button class="btn btn-info" id="Button1">Fill Accounts</button>
            </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-2">
                            <div class="row">
                                <div class="inputbox col-sm-4 py-2">
                                    <input id='TxtTotalOpening' type="text" class="" value="">
                                </div>

                                <div class="inputbox col-sm-4 py-2">
                                    <input id='TxtTotalAddition' type="text" class="" value="">
                                </div>

                                <div class="inputbox col-sm-4 py-2">
                                    <input id='TxtTotal' type="text" class="" value="">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-1">
                            <div class="row">
                                ...
                                <input id='TxtTotalDep' type="text" class="" value="">

                                </div>

                                <div class="inputbox col-sm-6 py-2">
                                <input id='TxtTOtalAssets' type="text" class="" value="">
                    ...
                    <div class="row">
                        ...
                        <div class="inputbox col-sm-6 py-2">
                            <input id='TxtCr' type="text" class="" value="">
                            <span class="" id="">Dr. Code</span>
                        </div>
                        <a name="" id="Button2" class="btn btn-info mx-1 mt-2 mb-2" role="button"><i
                    ...
                    <div class="row">
                        ...
                        <div class="inputbox col-sm-8 py-2">
                            <input class="" type="text" id="TxtDes" name="TxtDes">
                            <span id="">Ledger DEscription
                            </span>
                        </div>
                    ...
                    <div class="row py-5">
                        ...
                        <div class="mx-auto">
                            ...
                            <a name="" id="CmdPrintOrder" class="btn btn-primary mx-1" href="#" role="button"> <i
