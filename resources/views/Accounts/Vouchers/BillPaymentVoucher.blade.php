...
@section('title', 'Bill-Payment-Voucher')
        ...
        <div class="col-lg-12 pt-2">
            ...
            <div class="card mt-3">
                ...
                <div class="card-header">
                    <h3 class="text-bold text-center">Bill Payment Voucher</h3>
                </div>
                ...
                <div style="background-color:#EEE; " class="card-header">
                    ...
                    <div class="row">
                        ...
                        <div class=" ml-5 ">
                            /&nbsp;<strong>CR Note :</strong>&nbsp; <label id="TxtCreditNoteAmt"
                                class="VSN text-blue"></label>
                        </div>

                        <div class="ml-5">
                            /&nbsp;<strong>Recived Amount :</strong> &nbsp;<label id="MRecAmount" class="event_no text-blue"
                                for="event_no"></label>
                        </div>
                        <div class="ml-5">
                            /&nbsp;<strong>Balance :</strong> &nbsp;<label class="QuoteNo text-blue"
                                for="QuoteNo">quote121</label>
                        </div>
                        <div class="ml-5">
                            /&nbsp; <strong>Voucher #:&nbsp;</strong> <label class="customer text-blue"
                    ...
                    <span class="input-group-text" id="">Quote#</span>
                            ...
                            <a name="Button25" id="Button25" class="btn btn-info mx-2" href="#" role="button">Edit
                                Entry</a>
                        </div>
                        {{-- <div class="ml-5">
                ...
                <div class="card-body">
                    ...
                    <div class="row py-2">
                        ...
                        <div class="rdform row mx-5 mt-2">
                            ...
                            <input id="RadCashVoucher" type="radio" class="rainput" autocomplete="off" name="hopping2"
                                value="">
                        ...
                        <input id='TxtActCode' hidden type="text" class="" value="">
                        <input id='TxtActName' hidden type="text" class="" value="">
                        <a name="" id="Button6" hidden class="btn btn-danger" href="#" role="button"><i
                        ...
                        <div class="col-sm-6 row ml-5">
                            ...
                            <div class="inputbox col-sm-2">
                                <input id='TxtInvoiceAmount' type="text" class="" value="">
                                <span>Inv. Amt.</span>
                            </div>
                            ...
                            <div class="inputbox col-sm-2">
                                <input id='TxtDrNoteAmt' type="text" class="" value="">
                                <span>Debit</span>
                            </div>

                            <div class="inputbox col-sm-2">
                                <input id='TxtVoucherList' type="text" class="" value="">
                                <span>Vouch.</span>
                            </div>

                            <div class="inputbox col-sm-2">
                                <input id='TxtPaidAmount' type="text" class="" value="">
                                <span>Paid</span>
                            </div>

                            <div class="inputbox col-sm-2">
                                <input id='TxtBalanceAmt' type="text" class="" value="">
                                <span>Bal.</span>
                            </div>
                    ...
                    <div class="row py-2">
                        ...
                        <a name="" id="CmdCashCode" class="btn btn-info" href="#" role="button"><i
                        ...
                        <div class="col-sm-5 ml-2">
                            <div class="row">
                                ...
                                <div class="inputbox col-sm-4">
                                    <input type="date" id="TxtReconDate" name="TxtReconDate" class="">
                    ...
                    <input type="date" hidden id="TxtDateTo" name="TxtReconDate" class="">
                    <input type="date" hidden id="TxtDatefrom" name="TxtReconDate" class="">
                    <input type="date" hidden id="TxtBackLogDate" name="TxtReconDate" class="">
                    <input type="date" hidden id="TxtInvDate" name="TxtReconDate" class="">

                    <select hidden name="CmbCurrency" id="CmbCurrency">
                        <option></option>
                        <option></option>

                    </select>

                    <a name="" id="Button9" hidden href="#" role="button"></a>
                    <a name="" id="Button11" hidden href="#" role="button"></a>
                    <a name="" id="CmdActCode" hidden href="#" role="button"></a>
                    <a name="" id="Button4" hidden href="#" role="button"></a>
                    <a name="" id="Button7" hidden href="#" role="button"></a>


                    <div class="row py-2">

                        <div class="inputbox col-sm-1">
                            <input class="" readonly type="text" id="TxtSupplierCode" name="TxtSupplierCode">
                            <span id="">Code
                            </span>
                        </div>

                        <div class="inputbox col-sm-5">
                            <input class="" type="text" id="TxtSupplierName" name="TxtSupplierName">
                            <span id="">Vendor
                            </span>
                        </div>

                        <input hidden class="" type="text" id="TxtSupplierCode" name="TxtSupplierCode">

                        <a name="" id="Button13" class="btn btn-info" href="#" role="button"><i
                                class="fas fa-search"></i></a>

                        <input type="text" hidden id="TxtCustomerBalance" name="TxtCustomerBalance" class="">
                        <input type="text" hidden id="TxtBalance" name="TxtBalance" class="">

                        <label hidden id="Lbl1">Dr.</label>
                        <label hidden id="LblMark1">Dr.</label>

                        <a name="Button8" id="Button8" class="btn btn-info mx-3" href="#" role="button">A/c
                            Ledger</a>
                    ...
                    <div class="row py-2">
                        ...
                        <div class="inputbox col-sm-1">
                            <input id='TxtBillNo' name="TxtBillNo" type="text" class="" value="">
                            <span class="" id="">Bill #</span>
                        </div>

                        <a name="Button5" id="Button5" class="btn btn-info" href="#" role="button"><i
                                class="fa fa-search"></i></a>

                        <div class="inputbox col-sm-2">
                            <input id='TxtVendorBillNo' name="TxtVendorBillNo" type="text" class=""
                                value="">
                            <span class="" id="">Vendor Bill No. </span>
                        </div>

                        <div class="inputbox col-sm-2">
                            <input id='TxtAmount' name="TxtAmount" type="text" class="" value="">
                        ...
                        <div class="CheckBox1">
                            <label class="input-group text-info mx-2 mt-2">
                                <input id='ChkOKToPay' name="ChkOKToPay" type="checkbox" class="mr-1"
                                    value="">Ok to Pay
                            </label>
                        </div>
                    </div>
            ...
            {{-- <div class="card">
                <div class="card-body">
                    <div class="row py-2">
                        <div class="inputbox col-sm-1">
                            <input type="text" readonly id="TxtClientOrder" name="TxtClientOrder" class="">
                            <span class="">Inv #</span>

                        </div>
                        <div class="inputbox col-sm-1">
                            <input type="text" readonly id="TxtActCode" name="TxtActCode" class="">
                            <span class="">A/c Code </span>

                        </div>
                        <div class="inputbox col-sm-3">
                            <input type="text" readonly id="TxtActName" name="TxtActName" class="">
                            <span class="">A/c Name </span>

                        </div>

                        <div class="inputbox col-sm-2">
                            <input type="text" readonly id="TxtInvoiceAmt" name="TxtInvoiceAmt" class="">
                            <span class="">Invoice Amt</span>

                        </div>
                        <div class="inputbox col-sm-2">
                            <input type="text" id="TxtCrNote" name="TxtCrNote" class="">
                            <span class="">Credit Note</span>

                        </div>

                        <div class="inputbox col-sm-2">
                            <input type="text" id="TxtBank" name="TxtBank" class="">
                            <span class="">Bank Chrgs </span>
                    ...
                    <div class="row py-2">
                        ...
                        <div class="inputbox col-sm-2">
                            <input type="text" id="TxtInvAmount" name="TxtInvAmount" class="">
                            <span class="">Bank Rec Amt</span>

                        </div>
                        <div class="inputbox col-sm-2">
                            <input type="text" id="TxtAmount" readonly name="TxtAmount" class="">
                            <span class="">Cust Rec Amt </span>

                        </div>
                        <div class="inputbox col-sm-2">
                            <input type="text" id="TxtDesc" name="TxtDesc" class="">
                            <span class="">Description </span>
                            <input type="hidden" id="TxtCurrency" name="TxtCurrency" class="">
                            <input type="hidden" id="TxtRefno" name="TxtRefno" class="">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="row py-2">
                        ...
                        <a name="" id="Button12" class="btn btn-info col-sm-1 mx-2" role="button">Bill</a>
                        ...
                        <div class="inputbox col-sm-2 mx-1">
                            <input type="date" id="TxtChqDate" name="TxtChqDate" class="">
                            <span class="">Check Date</span>
                        </div>

                        <div class="inputbox col-sm-1 mx-1">
                            <input type="text" id="TxtExpCode" name="TxtExpCode" class="">
                            <span class="">Exp. Code</span>
                        </div>
                    ...
                    <div class="row py-2">
                        ...
                        <div class="inputbox col-sm-5">
                            <input class="" type="text" id="TxtExpName" name="TxtExpName">
                            <span id="">Bank/Cash/A.C
                            </span>
                        </div>

                        <a name="Button17" id="Button17" class="btn btn-info" href="#" role="button"><i
                            class="fa fa-search"></i></a>

                            <div class="inputbox col-sm-2 mx-1">
                                <input type="text" id="TxtBankCharges" name="TxtBankCharges" class="">
                                <span class="">Exp. Amt.</span>
                            </div>

                            <div class="inputbox col-sm-2 mx-1">
                                <input type="text" id="TxtNetTotal" name="TxtNetTotal" class="">
                    ...
                    <div class="row py-2">
                        ...
                        <div class="mx-auto">
                            <a name="CmdAdd" id="CmdAdd" class="btn btn-primary" role="button"><i
                            ...
                            <a name="CmdDelete" id="CmdDelete" class="btn btn-warning" href="#" role="button"> <i
                                    class="fas fa-trash"></i> Delete</a>
                                    <a name="CmdPrint" id="CmdPrint" class="btn btn-primary" href="#" role="button"> <i
                                        class="fas fa-print"></i> Print</a>
                                <a name="CmdExit" id="CmdExit" class="btn btn-success" href="#" role="button"><i
                                        class="fas fa-paper-plane"></i> Send</a>
                            <a name="CmdExit" id="CmdExit" class="btn btn-danger" href="#" role="button"><i
                                    class="fas fa-door-open"></i> Exit</a>
                        </div>
