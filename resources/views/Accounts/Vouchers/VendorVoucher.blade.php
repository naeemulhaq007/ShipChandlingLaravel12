        ...
        <div class="col-lg-12 pt-2">
            ...
            <div class="card">
                ...
                <div class="card-header">
                        <h3 class="text-center text-bold">Vendor Payment Voucher</h3>
                </div>
                ...
                <div class="card-body">
                    ...
                    <div class="row py-2">
                        ...
                        <div class="rdform row mx-5 mt-2">
                            ...
                            <input id="RadBankVoucher" type="radio" class="rainput" autocomplete="off" name="hopping2" value="" checked>
                            <label class="ralabel mx-2" for="RadBankVoucher"><span></span>Bank Voucher</label>

                            <input id="RadCashVoucher" type="radio" class="rainput" autocomplete="off" name="hopping2" value="">
                        ...
                        <div class="col-sm-6 row ml-5">
                            ...
                            <div class="inputbox col-sm-4">
                                <input id='TxtDateActYear' type="date" class=""
                                    value="">
                                    <span>Year</span>
                            </div>
                    ...
                    <div class="row py-2">
                        ...
                        <div class="inputbox col-sm-1">
                            <input class="" readonly type="text" id="TxtActCashCode"
                            name="TxtActCashCode">
                            <span id="">Code
                            </span>
                        </div>
                        ...
                        <div class="inputbox col-sm-5">
                            <input class="" type="text" id="TxtActCashName"
                            name="TxtActCashName">
                        ...
                        <div class="inputbox col-sm-2">
                            ...
                            <span class="">Bank Reconcilation User</span>
                        </div>
                    ...
                    <div class="row py-2">
                        ...
                        <div class="inputbox col-sm-5">
                            ...
                            <span id="">Vendor / Payable</span>
                        </div>

                        <div class="inputbox col-sm-2">
                            <input type="text" id="TxtReconWorkUser" name="TxtReconWorkUser" class="">
                            <span class="">Vendor Reconcilation User</span>
                        </div>
                        ...
                        {{-- <div class="btn-group ml-2" data-toggle="buttons">
                            <label class="btn btn-default active">
                                <input type="radio" name="options" id="OptOrderPO" autocomplete="off" checked> Order
                                PO
                            </label>
                            <label class="btn btn-default">
                                <input type="radio" name="options" id="OptStockPO1" autocomplete="off"> Stock PO
                            </label>
                            <label class="btn btn-default">
                                <input type="radio" name="options" id="OptVendorCrNote" autocomplete="off"> V.Cr Note
                            </label>
                        </div> --}}
                    </div>
                    ...
                    <div class="row py-2">
                        ...
                        <div class="rdform row mx-3 mt-2">

                            <input id="OptOrderPO" type="radio" class="rainput" name="hopping" value="">
                            <label class="ralabel mx-2" for="OptOrderPO"><span></span>Order PO</label>

                            <input id="OptStockPO1" type="radio" class="rainput" name="hopping" value="">
                            <label class="ralabel  mx-2" for="OptStockPO1"><span></span>Stock PO</label>

                            <input id="OptVendorCrNote" type="radio" class="rainput" name="hopping" value="" checked>
                            <label class="ralabel  mx-2" for="OptVendorCrNote"><span></span>V.Cr Note</label>
                        ...
                        <div class="inputbox col-sm-2">
                            <input id='TxtChargeNo' name="TxtChargeNo" type="text" class="" value="" readonly>
                            <span id="">Charge #</span>
                        </div>

                        <div class="inputbox col-sm-3">
                            <input id='TxtVesselName' readonly name="TxtVesselName" type="text" class="" value="">
                            <span id="">Vessel Name </span>
                        </div>

                        <a name="Button7" id="Button7" class="btn btn-info mx-1" href="#" role="button">A/c
                            Ledger</a>
                        <a name="Button11" id="Button11" class="btn btn-info mx-1" href="#"
                            role="button">Fill</a>

                        <div class="inputbox col-sm-2">
                            <input id='TxtCustomerBalance' readonly name="TxtCustomerBalance" type="text"
                            class="" value="">
                            <span id="">Customer Balance</span>
                        </div>

                        <div class="inputbox col-sm-1">
                            <input type="text" id="TxtStatus" readonly name="TxtStatus" class="">
                            <span id="">Status</span>
                        </div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row py-2">
                        ...
                        <div class="inputbox col-sm-1">
                            <input type="text" id="TxtClientOrder" name="TxtClientOrder" class="">
                            <span class="">INV / PO #</span>
                        </div>

                        <div class="inputbox col-sm-1">
                            <input type="text" id="TxtVendorBillNo" name="TxtVendorBillNo" class="">
                            <span class="">Vendor Bill</span>
                        </div>
                        ...
                        <div class="inputbox col-sm-1">
                            <input type="date" id="TxtPODate" name="TxtPODate" class="">
                            <span class="">Date</span>
                        </div>

                        <div class="inputbox col-sm-1">
                            <input type="text" id="TxtGodownCode" name="TxtGodownCode" class="">
                            <span class="">W. Code</span>
                        </div>

                        <div class="inputbox col-sm-1">
                            <input type="text" id="TxtGodownName" name="TxtGodownName" class="">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="row py-2">
                        ...
                        <div class="inputbox col-sm-1">
                            <input type="text" id="TxtTotInvAmt" name="TxtTotInvAmt" class="">
                            <span class="">Inv. Amt.</span>
                        </div>

                        <div class="inputbox col-sm-1">
                            <input type="text" id="TxtTotBankCharges" name="TxtTotBankCharges" class="">
                            <span class="">B. Charges</span>
                        </div>
                        ...
                        <div class="inputbox col-sm-2">
                            <input class="" type="text" name="TxtTotAmount" id="TxtTotAmount">
                    ...
                    <div class="row py-2">
                        ...
                        <div class="inputbox col-sm-2">
                            <input class="" type="text" name="TxtNetTotal" id="TxtNetTotal">
...
@section('js')
    ...
    <script>
        $(document).ready(function() {
            // Create a new URLSearchParams object from the current URL search parameters
            const searchParams = new URLSearchParams(window.location.search);

            // Get the value of the "pv" parameter
            const pv = searchParams.get('pv');
            // console.log(pv); // Output: "388"
            ...
            $.ajax({
                ...
                success: function(resposne) {
                    ...
                    data.forEach(function(item) {
                        ...
                        let ClientOrderNoCell = row.insertCell(0);
                        ClientOrderNoCell.innerHTML = item.ClientOrderNo;

                        let VendorBillNoCell = row.insertCell(1);
                        VendorBillNoCell.innerHTML = item.VendorBillNo;

                        let ChargeNoCell = row.insertCell(2);
                        ChargeNoCell.innerHTML = item.ChargeNo;

                        let ActCodeCell = row.insertCell(3);
                        ActCodeCell.innerHTML = item.ActCode;

                        let AccountNameCell = row.insertCell(4);
                        AccountNameCell.innerHTML = item.ActName;

                        let BankNameCell = row.insertCell(5);
                        ...
                        let AmountCell = row.insertCell(6);
                        AmountCell.innerHTML = parseFloat(item.Amount).toFixed(2);

                        let POTypeCell = row.insertCell(7);
                        POTypeCell.innerHTML = item.POType;
                    ...
                    tableBody.addEventListener("dblclick", function(e) {
                        if (e.target.tagName === "TD") {
                            ...
                            // inputField.value = ;
                            $('#TxtClientOrder').val(tdElements[0].innerHTML);
                            $('#TxtVendorBillNo').val(tdElements[1].innerHTML);
                            $('#TxtChargeNo').val(tdElements[2].innerHTML);
                            $('#TxtActCode').val(tdElements[3].innerHTML);
                            $('#TxtActName').val(tdElements[4].innerHTML);
                            $('#TxtActCashName').val(tdElements[5].innerHTML);

                            // Set the formatted date as the value of the input field
                            // document.getElementById("TxtChqDate").value = formattedDate;
                            // alert(tdElements[3].innerHTML);
                            $('#TxtAmount').val(tdElements[6].innerHTML);
                            $('#TxtClientOrder').val(tdElements[7].innerHTML);
                            $('#TxtDesc').val(tdElements[8].innerHTML);
                            // $('#TxtBank').val(tdElements[11].innerHTML);
                            var date = new Date(tdElements[9].innerHTML);
                            var formattedDate = date.getFullYear() + '-' + (date.getMonth() + 1)
                                .toString().padStart(2, '0') + '-' + date.getDate().toString().padStart(
                                    2, '0');
                            $('#TxtPODate').val(formattedDate);
