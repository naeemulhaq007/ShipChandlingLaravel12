...
@section('title', 'Bill-Receipt-Voucher')
        ...
        <div class="col-lg-12 pt-2">
            ...
            <div class="card mt-3">
                ...
                <div class="card-header">
                    <h3 class="text-bold text-center">Bill Receipt Voucher</h3>
                </div>
                ...
                <div style="background-color:#EEE; " class="card-header">
                    ...
                    <span class="input-group-text" id="">Quote#</span>
                            ...
                            <a name="" id="Button27" data-voucherno="" class="btn btn-info mx-1" role="button"><i
                                    class="fa fa-pencil mr-2" aria-hidden="true"></i>Edit Entry</a>
                ...
                <div class="card-body">
                    ...
                    <input class="" hidden type="text" id="TxtActName" name="TxtActName">
                    <input class="" hidden type="text" id="TxtActCode" name="TxtActCode">
                    ...
                    <div class="row py-2">
                        ...
                        <div class="col-sm-5">
                            <div class="row">
                                ...
                                <a name="" id="CmdCashCode" class="btn btn-info" role="button"><i
                        ...
                        <div class="inputbox col-sm-2">
                            ...
                            <span class="">Voucher List</span>
                        </div>

                        <div class="inputbox col-sm-2">
                            <input type="text" id="TxtPaidAmount" name="TxtPaidAmount" class="">
                            <span class="">Paid Amount</span>
                        </div>

                        <div class="inputbox col-sm-2">
                            <input type="text" id="TxtBalanceAmt" name="TxtBalanceAmt" class="">
                    ...
                    <div class="row py-2">
                        ...
                        <div class="col-sm-6">
                            <div class="row">
                                <div class="inputbox col-sm-11">
                                    <input class="" type="text" id="TxtCustomerName" name="TxtCustomerName">
                                    <span id="">Customer
                                    </span>
                                </div>

                                <a name="" id="Button13" class="btn btn-info" role="button"><i
                                        class="fa fa-search" aria-hidden="true"></i></a>

                                <input class="" hidden type="text" id="TxtCustomerCode" name="TxtCustomerCode">
                            </div>
                        </div>

                        <div class="inputbox col-sm-2">
                            <input type="text" id="TxtBalance" name="TxtBalance" class="">
                            <span class="">Balance</span>
                        </div>

                        <div class="col-sm-1" id="LblMark1">
                            Dr
                        </div>

                        <a name="" id="Button8" class="btn btn-info" role="button">A/C Ledger</a>

                        <div class="col-sm-1" id="Lbl1">
                            Dr
                        </div>
                    ...
                    <div class="row py-2">
                        ...
                        <div class="col-sm-3">
                            <div class="row">
                                <div class="inputbox col-sm-10">
                                    <input id='TxtBillNo' name="TxtBillNo" type="text" class=""
                                        value="">
                                    <span class="" id="">Invoice #</span>
                                </div>

                                <a name="" id="Button5" class="btn btn-info ml-2" role="button"><i
                                        class="fa fa-search" aria-hidden="true"></i></a>
                            </div>
                        </div>
                        ...
                        <div class="inputbox col-sm-3">
                            <input id='TxtVendorBillNo' name="TxtVendorBillNo" type="text" class=""
                                value="">
                            <span class="" id="">Customer Inv. No.</span>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <a name="" id="Button11" class="btn btn-info col-sm-1 ml-2 mt-2 mb-2" role="button">Fill</a>

                        <div class="CheckBox1">
                            <label class="input-group text-info ml-4 mt-3">
                ...
                <div class="card-body">
                    <div class="row py-2">
                        <div class="inputbox col-sm-3">
                            ...
                            <span class="Txtspan">Cheque No / Wire Transfer #</span>
                        ...
                        <div class="inputbox col-sm-2">
                            ...
                            <span class="">Cheque No</span>
                        </div>

                        <div class="inputbox col-sm-2">
                            <input type="date" id="TxtChqDate" name="TxtChqDate" class="">
                            <span class="">Cheque Date</span>
                        </div>
                    ...
                    <div class="row py-2">
                        ...
                        <a name="" id="Button16" class="btn btn-info" role="button"><i
                    ...
                    <div class="row py-3">
                        ...
                        <div class="mx-auto">
                            <a name="" id="CmdAdd" class="btn btn-primary" role="button"><i
                            ...
                            <a name="" id="CmdDelete" class="btn btn-warning" href="#" role="button"> <i
                                    class="fas fa-trash"></i> Delete</a>

                            <a name="" id="CmdPrint" class="btn btn-primary" href="#" role="button"> <i
                                     class="fas fa-print"></i> Print</a>

                            <a name="" id="CmdExit" class="btn btn-danger" href="#" role="button"><i
