...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="col-lg-12 pt-2">
            ...
            <div class="card mt-3">
                ...
                <div class="card-header">
                    <h3 class="text-bold text-center">Credit Note</h3>
                </div>
                ...
                <div style="background-color:#EEE; " class="card-header">
                    ...
                    <div class="row">
                        ...
                        <div class="ml-5 row">
                            ...
                            <a name="" id="Button18" class="btn btn-info mx-1" href="#" role="button"><i
                                    class="fas fa-pencil mr-2"></i>Edit Entry</a>
                ...
                <div class="card-body">
                    ...
                    <div class="row pt-2">
                        ...
                        <div class="col-sm-6 row mr-5">

                            <div class="inputbox col-sm-4 ml-3">
                                <input id='TxtChqNo' type="text" class="" value="">
                                <span>Chq. No.</span>
                            </div>

                            <div class="inputbox col-sm-4">
                                <input id='TxtChqDate' type="date" class="" value="">
                                <span>Chq. date</span>
                            </div>

                            <div class="inputbox col-sm-3">
                                <input id='TxtDateActYear' type="date" class="" value="">
                                <span>Act Year Date</span>
                            </div>


                        </div>

                        <div class="rdform row mx-4 mt-2">

                            <input id="RadBankVoucher" type="radio" class="rainput" autocomplete="off"
                    ...
                    <div class="row">
                        ...
                        <div class="inputbox">
                            <input class="" readonly type="hidden" id="TxtActCashCode" name="TxtActCashCode">
                        </div>
                        ...
                        <div class="col-sm-5">
                            <div class="row">
                                ...
                                <a name="" id="CmdCashCode" class="btn btn-info mt-2 mb-2 col-sm-1"
                                    href="#" role="button"><i class="fas fa-search"></i></a>
                            </div>
                        </div>

                        <div class="inputbox col-sm-2 py-2 ml-2">
                            <input type="text" id="TxtInvoiceAmount" name="TxtInvoiceAmount" class="">
                            <span class="">Invoice Amount</span>
                        </div>

                        <div class="inputbox col-sm-1 py-2">
                            <input type="text" id="TxtCreditNoteAmt" name="TxtCreditNoteAmt" class="">
                            <span class="">Credit Note</span>
                        </div>

                        <div class="inputbox col-sm-1 py-2 ml-2">
                            <input type="text" id="TxtVoucherList" name="TxtVoucherList" class="">
                            <span class="">Voucher #</span>
                        </div>


                        <div class="inputbox col-sm-2 py-2 ml-2">
                            <input id='TxtRecAmount' name="TxtRecAmount" type="text" class="" value="">
                            <span class="" id="">Received Amount</span>
                        </div>
                    ...
                    <div class="row py-2">
                        ...
                        <div class="inputbox col-sm-3">
                            <input id='TxtBalanceRv' name="TxtBalanceRv" type="text" class="" value="">
                            <span class="" id="">Balance Rcvd.</span>
                        </div>

                        <div class="inputbox col-sm-2 ml-2">
                            <input id='TxtBalance' name="TxtBalance" type="text" class="" value="">
                            <span class="" id="">Balance</span>
                        </div>
                        ...
                        <div class="inputbox col-sm-2">
                            <input id='TxtCusRefNo' name="TxtCusRefNo" type="text" class="" value="">
                            <span class="" id="">Ref. #</span>
                        </div>

                        <div class="inputbox col-sm-2 ml-2">
                            <input type="text" id="TxtCustomerBalance" name="TxtCustomerBalance" class="">
                            <span class="" id="">Cus. Balance</span>
                        </div>
                    ...
                    <div class="row py-2">
                        ...
                        <div class="inputbox col-sm-1">
                            <input id='TxtActCode' name="TxtActCode" type="text" class="" value="">
                            <span class="" id="">Cr. Code</span>
                        </div>

                        <div class="inputbox col-sm-4 ml-2">
                            <input id='TxtActName' name="TxtActName" type="text" class="" value="">
                            <span class="" id="">Cr. A/c Name</span>
                        </div>
                        ...
                        <div class="inputbox col-sm-1">
                            <input id='TxtPer' name="TxtPer" type="text" class="" value="">
                            <span class="" id="">%</span>
                        </div>

                        <div class="inputbox col-sm-2">
                            <input type="text" id="TxtCrAmt" name="TxtCrAmt" class="">
                            <span class="" id="">Cr. Note Amt.</span>
                        </div>
                    ...
                    <div class="row py-2">
                        ...
                        <div class="mx-auto">
                            <a name="" id="BtnAdd" class="btn btn-info" role="button">Add</a>

                            <a name="CmdSave" id="Button1" class="btn btn-info" role="button">Edit</a>

                            <a name="" id="Button2" class="btn btn-info" href="#"
                                role="button">Delete</a>

                            <a name="" id="Button3" class="btn btn-info" href="#" role="button">End</a>
                        </div>
        ...
        <div class="card">
            <div class="card-header">
                <div class="row">
                    <h3 class="mx-auto text-bold">Billing Information</h5>
                        <div class="card-tools ">
                            <button type="button" class="btn btn-light ml-auto" data-card-widget="collapse">
                                Hide
                            </button>
                        </div>
                </div>
            ...
            <div class="card-body">
                ...
                <div class="row py-2">
                    ...
                    <div class="inputbox col-sm-10">
                        <input type="text" id="TxtBillingCompany" name="TxtBillingCompany" class="">
                ...
                <div class="row py-2">
                    ...
                    <div class="inputbox col-sm-10">
                        <input type="text" id="TxtBillingAddress" name="TxtBillingAddress" class="">
        ...
        <div class="card">
            <div class="card-body">
                <div class="row py-2">
                    ...
                    <div class="CheckBox1">
                        <label class="input-group text-info mt-2 ml-2">
                            <input type="checkbox" id="ChkCompanyHeading" name="ChkCompanyHeading"
                                class="mx-2">Company Heading</label>
                    </div>
                    ...
                    <div class="inputbox col-sm-2">
                        <input type="date" id="TxtTotAmount" name="TxtTotAmount" class="">
                        <span>Total Amount</span>
                    </div>

                    <div class="inputbox col-sm-2">
                        <input type="text" id="CreditNote" name="CreditNote" class="">
                    ...
                    <div class="CheckBox1">
                        <label class="input-group text-info mt-2 ml-2">
                            <input type="checkbox" id="ChkCommIncome" name="ChkCommIncome" class="mx-2">Received
                            Commission Income</label>
                    </div>
                </div>
                ...
                <div class="row py-2">
                    ...
                    <div class="inputbox col-sm-10">
                        <input type="text" id="TxtBankDescription" name="TxtBankDescription" class="">
                        <span>Dr. Description</span>
                    </div>

                    <a name="" id="Button16" class="btn btn-info mx-1" role="button"><i
                            class="fa fa-paper-plane mr-1" aria-hidden="true"></i> Send</a>
                ...
                <div class="row py-2">
                    ...
                    <div class="mx-auto">
                        ...
                        <a name="" id="CmdDelete" class="btn btn-warning mx-1" href="#" role="button"> <i
                                class="fas fa-trash mr-1"></i> Delete</a>

                        <a name="" id="CmdPrint" class="btn btn-primary mx-1" href="#" role="button"> <i
                                class="fas fa-print mr-1"></i> Print</a>

                        <a name="" id="CmdExit" class="btn btn-danger mx-1" href="#" role="button"><i
