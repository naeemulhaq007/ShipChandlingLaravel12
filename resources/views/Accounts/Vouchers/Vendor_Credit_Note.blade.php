...
@section('title', 'Vendor-Credit-Note')
        ...
        <div class="col-lg-12 pt-2">
            ...
            <div class="card mt-3">
                ...
                <div class="card-header">
                    <h3 class="text-bold text-center">Vendor Credit Note</h3>
                </div>
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="inputbox col-sm-2 ml-2 py-2">
                    ...
                    <div class="row py-2">
                        ...
                        <div class="inputbox">
                            <input class="" readonly type="hidden" id="TxtGodownCode" name="TxtGodownCode">
                        </div>

                        <div class="col-sm-7">
                            <div class="row">
                                <div class="inputbox col-sm-11 py-2">
                                    <input class="" type="text" id="TxtGodownName" name="TxtGodownName">
                                    <span id="">Location
                                    </span>
                                </div>

                                <a name="" id="Button4" class="btn btn-info mt-2 mb-2 col-sm-1" href="#"
