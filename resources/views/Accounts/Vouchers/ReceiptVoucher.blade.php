        ...
        <div class="col-lg-12 pt-2">
            ...
            <div class="card mt-3">
                ...
                <div class="card-header">
                        <h3 class="text-bold text-center">Receipt Voucher</h3>
                </div>
                ...
                <div class="card-body">
                    ...
                    <div class="row py-2">
                        ...
                        <div class="inputbox col-sm-3">
                            <input id='TxtRefNo' readonly name="TxtRefNo" type="text" class="" value="">
                            <span class=""  id="">Delivery Order #</span>
                        </div>
                        ...
                        <div class="inputbox col-sm-2">
                            <input id='TxtCustomerBalance' readonly name="TxtCustomerBalance" type="text" class="" value="">
                            <span class="" id="">Customer Balance</span>
                        </div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="row py-2">
                        <div class="inputbox col-sm-1">
                            <input type="text" readonly id="TxtClientOrder" name="TxtClientOrder"
                            class="">
                            <span class="">Inv #</span>
