    ...
    <div class="card-body">
      <div class="container-fluid">
        <div class="row d-flex align-items-baseline header_section">
          <div class="col-xl-4">
            <img class="img-fluid ml-3" src="<?php echo url("assets/images/logo.png");?>" style="width: 150px;">

            <p><strong style="color: #01004e;font-size: 14px;">{{ $dataf ? $dataf->CompanyName : 'GSS'}}</strong><br>
                <strong style="color: #01004e;font-size: 12px;">{{ $dataf ? $dataf->CompanyAddress : 'Address'}}</strong><br>
                <strong style="color: #01004e;font-size: 10px;">{{ $dataf ? $dataf->CompanyEmailAddress : 'usa@GSS.us'}} </strong>
                <br><span style="color: #01004e;font-size: 10px;">{{ $dataf ? $dataf->CompanyWebSite : 'www.GSS.us'}}</span></p>
          </div>
          <div class="col-xl-2 ">
